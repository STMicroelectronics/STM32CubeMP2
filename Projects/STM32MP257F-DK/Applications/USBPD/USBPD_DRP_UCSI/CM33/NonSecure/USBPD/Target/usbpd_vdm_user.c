...
{
  {
    ...
    .VDM_bcdDevice_SOP          = 0x0200,        /*!< A unique number assigned by the Vendor ID holder containing identity information relevant to the release version of the product. */
    ...
    case PRODUCT_TYPE_PERIPHERAL: /*!< PDUSB Peripheral (UFP)                       */
      {
        ...
        USBPD_UFPVdo_TypeDef      ufp_vdo =
        {
          ...
          .b.UFPVDOVersion    = USBPD_VDM_VDO_UFP_VERSION_REV1P2, /*!< Version Number of the VDO
                                                                       (should be set to Version1.2) */
        };
    ...
    case PRODUCT_TYPE_POWER_BRICK:  /*!< Power Brick (DFP)                      */
      {
        ...
        USBPD_DFPVdo_TypeDef      dfp_vdo =
        {
          ...
          .b.DFPVDOVersion     = USBPD_VDM_VDO_DFP_VERSION_REV1P1,   /*!< Version Number of the VDO
                                                                          (should be set to Version1.1) */
        };
...
/* USER CODE BEGIN USBPD_VDM_UserInit */
  /* Fill DPM_VDM_Settings manually, as the structure default values are handled by CubeMX, which does not support
     editing it when VDM support is set to disabled */
  DPM_VDM_Settings[0].VDM_XID_SOP            = USBPD_XID;
  DPM_VDM_Settings[0].VDM_USB_VID_SOP        = USBPD_VID;
  DPM_VDM_Settings[0].VDM_PID_SOP            = USBPD_PID;
  DPM_VDM_Settings[0].VDM_ModalOperation     = MODAL_OPERATION_NONSUPP;
  DPM_VDM_Settings[0].VDM_bcdDevice_SOP      = 0x0200;
  DPM_VDM_Settings[0].VDM_USBHostSupport     = USB_CAPABLE;
  DPM_VDM_Settings[0].VDM_USBDeviceSupport   = USB_CAPABLE;
  DPM_VDM_Settings[0].VDM_ProductTypeUFPorCP = PRODUCT_TYPE_PERIPHERAL;
  DPM_VDM_Settings[0].VDM_ProductTypeDFP     = PRODUCT_TYPE_HOST;
