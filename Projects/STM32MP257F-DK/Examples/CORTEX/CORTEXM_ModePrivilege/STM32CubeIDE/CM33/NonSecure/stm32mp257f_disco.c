...
static GPIO_TypeDef* BUTTON_PORT[BUTTONn] = {BUTTON_WAKEUP_GPIO_PORT, BUTTON_USER1_GPIO_PORT, BUTTON_USER2_GPIO_PORT, BUTTON_TAMPER_GPIO_PORT};
static const uint16_t BUTTON_PIN[BUTTONn] = {BUTTON_WAKEUP_PIN, BUTTON_USER1_PIN, BUTTON_USER2_PIN, BUTTON_TAMPER_PIN};
static const IRQn_Type BUTTON_IRQn[BUTTONn] = {BUTTON_WAKEUP_EXTI_IRQn, BUTTON_USER1_EXTI_IRQn, BUTTON_USER2_EXTI_IRQn, BUTTON_TAMPER_EXTI_IRQn};

#elif defined (CORE_CM0PLUS)
#warning "Core M0 can't manage LED in disco Board"
#endif /* CORE_CA35 || CORE_CM33*/
