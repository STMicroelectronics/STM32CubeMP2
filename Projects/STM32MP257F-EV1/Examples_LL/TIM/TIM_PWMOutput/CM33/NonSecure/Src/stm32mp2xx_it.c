...
/**
* @brief  This function handles TIM8 interrupt.
* @param  None
* @retval None
*/
...
/**
  ...
  * @retval None
  */
void USER2_BUTTON_IRQHANDLER(void)
{
  /* Manage Flags */
  if(LL_EXTI_IsActiveFallingFlag_0_31(EXTI2, USER2_BUTTON_EXTI_LINE) != RESET)
  {
    LL_EXTI_ClearFallingFlag_0_31(EXTI2, USER2_BUTTON_EXTI_LINE);
