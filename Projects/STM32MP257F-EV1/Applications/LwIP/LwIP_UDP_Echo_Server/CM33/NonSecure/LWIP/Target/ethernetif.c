...
rtl8211_Object_t RTL8211;
rtl8211_IOCtx_t  RTL8211_IOCtx = {ETH_PHY_IO_Init,
                                  ETH_PHY_IO_DeInit,
                                  ETH_PHY_IO_WriteReg,
                                  ETH_PHY_IO_ReadReg,
                                  ETH_PHY_IO_GetTick};
...
void ethernet_link_check_state(struct netif *netif)
{
  ...
  PHYLinkState = RTL8211_GetLinkState(&RTL8211);
	...
	/* Get link state */
  if(netif_is_link_up(netif) && (PHYLinkState <= RTL8211_STATUS_LINK_DOWN)){
