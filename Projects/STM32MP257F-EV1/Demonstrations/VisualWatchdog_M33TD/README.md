...
In the current STM32MP257F-EV1 VisualWatchdog profile, `NSCoreApp_Init()` starts the enabled utility tasks below:
...
1. Navigate to `Firmware/Projects/STM32MP257F-EV1/Demonstrations/VisualWatchdog_M33TD`.
...
**Note**: Each TSV requires three sets of binaries. Refer to the [Reference Use Cases for MP25-EV1 Board (VisualWatchdog Project)](#reference-use-cases-for-mp25-ev1-board-visualwatchdog-project) section for details.
...
1. **Configure and Build TFM Secure**:
   Use specific CMake options defined for each boot mode as described in the **Required CMake Options** section under [Reference Use Cases for MP25-EV1 Board (VisualWatchdog Project)](#reference-use-cases-for-mp25-ev1-board-visualwatchdog-project).
...
3. **Rename Generated Binaries**:
   Rename the binaries in the `bin/` folder to match the required binaries for the specific TSV as described in the **Required Binaries** section under [Reference Use Cases for MP25-EV1 Board (VisualWatchdog Project)](#reference-use-cases-for-mp25-ev1-board-visualwatchdog-project).

---

## Reference Use Cases for MP25-EV1 Board (VisualWatchdog Project)
...
- `tfm-visualwatchdog-stm32mp257f-ev1-cm33tdcid-ostl-emmc-emmc_s_ns_Signed.bin`
...
- `tfm-visualwatchdog-stm32mp257f-ev1-cm33tdcid-ostl-nor-emmc_s_ns_Signed.bin`
...
- `bl2-stm32mp257f-ev1-cm33tdcid-ostl-nor.stm32`
- `ddr_phy-stm32mp257f-ev1-cm33tdcid-ostl-nor_Signed.bin`
- `tfm-visualwatchdog-stm32mp257f-ev1-cm33tdcid-ostl-nor-nor_s_ns_Signed.bin`
...
- `bl2-stm32mp257f-ev1-cm33tdcid-ostl-nor.stm32`
- `ddr_phy-stm32mp257f-ev1-cm33tdcid-ostl-nor_Signed.bin`
- `tfm-visualwatchdog-stm32mp257f-ev1-cm33tdcid-ostl-nor-sdcard_s_ns_Signed.bin`
...
- `tfm-visualwatchdog-stm32mp257f-ev1-cm33tdcid-ostl-sdcard-sdcard_s_ns_Signed.bin`
