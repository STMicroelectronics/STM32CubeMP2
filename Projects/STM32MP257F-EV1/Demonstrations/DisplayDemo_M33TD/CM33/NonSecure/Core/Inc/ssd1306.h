...
#elif defined(SSD1306_USE_COM)
#else
#error "You should define SSD1306_USE_SPI or SSD1306_USE_COM or SSD1306_USE_I2C macro!"
#endif
...
/**
 * @brief Communication interface structure for SSD1306 display.
 *
 * This structure defines function pointers for communication operations
 * with the SSD1306 display, including writing commands, writing data,
...
/**
 * @brief Sets the communication interface for the SSD1306 display.
 *
 * This function assigns the provided communication interface structure
 * to be used for subsequent SSD1306 operations.
 *
 * @param comm Pointer to the communication interface structure.
 */
void SSD1306_SetCommInterface(const SSD1306_Comm_t* comm);
