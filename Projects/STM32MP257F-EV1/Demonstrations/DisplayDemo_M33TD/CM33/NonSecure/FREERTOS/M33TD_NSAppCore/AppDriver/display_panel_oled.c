...
/* Private variables ---------------------------------------------------------*/
/** @brief SSD1306 communication hooks backed by the project I2C helpers. */
static const SSD1306_Comm_t displayPanelOledComm =
{
  .WriteCommand = MX_I2C_WriteCommand,
  .WriteData = MX_I2C_WriteData,
  .Reset = NULL,
};
...
/**
  * @brief  Power off the OLED panel and release the I2C transport.
  * @retval None
  */
static void DisplayPanel_OledPowerOff(void)
{
