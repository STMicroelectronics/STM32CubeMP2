...
/**
  * @brief This function handles I3C4 event interrupt.
  */
void I3C4_IRQHandler(void)
{
  /* USER CODE BEGIN I3C4_EV_IRQn 0 */

  /* USER CODE END I3C4_EV_IRQn 0 */
  HAL_I3C_EV_IRQHandler(&hi3c4);
  HAL_I3C_ER_IRQHandler(&hi3c4);
  /* USER CODE BEGIN I3C4_EV_IRQn 1 */

  /* USER CODE END I3C4_EV_IRQn 1 */
}
...
void HPDMA3_Channel2_IRQHandler(void)
{
    ...
    } else if (hi3c4.hdmatx->Instance == HPDMA3_Channel2) {
        // I3C DMA handling
...
{
  /* USER CODE BEGIN SPI3_EV_IRQn 0 */

  /* USER CODE END SPI3_EV_IRQn 0 */
  HAL_SPI_IRQHandler(&SpiHandle);
  /* USER CODE BEGIN SPI3_EV_IRQn 1 */

  /* USER CODE END SPI3_EV_IRQn 1 */
}
