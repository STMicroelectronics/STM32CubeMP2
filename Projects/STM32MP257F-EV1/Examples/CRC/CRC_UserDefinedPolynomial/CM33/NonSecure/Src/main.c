...
/**
  ******************************************************************************
  * @file    CRC/CRC_UserDefinedPolynomial/CM33/NonSecure/Src/main.c
...
/**
  ...
  * @retval None
  */
static void MX_CRC_DeInit()
{
	/* Deinitialize the CRC peripheral */
	HAL_CRC_DeInit(&hcrc);

	/* Release CRC using Resource manager */
	ResMgr_Release(RESMGR_RESOURCE_RIFSC, RESMGR_RIFSC_CRC_ID);
...
{
	/* Deinitialize the CRC peripheral and resources */
	MX_CRC_DeInit();
