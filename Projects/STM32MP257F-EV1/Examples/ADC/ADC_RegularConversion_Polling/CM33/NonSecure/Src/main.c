...
/**
  ******************************************************************************
  * @file    ADC/ADC_RegularConversion_Polling/Application/User/main.c
...
int main(void)
{
  ...
  printf("ADC Example (ADC_RegularConversion) execution started :\r\n");
  ...
  printf("uwConvertedValue = %lu,    uwInputVoltage = %ld    (ADC_RegularConversion)\r\n", uwConvertedValue, uwInputVoltage);
