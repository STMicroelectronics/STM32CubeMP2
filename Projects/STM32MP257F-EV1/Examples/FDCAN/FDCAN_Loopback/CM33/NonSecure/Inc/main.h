...
#define FDCANx_RX_GPIO_CLK_ENABLE() 	__HAL_RCC_GPIOG_CLK_ENABLE()
#define FDCANx_TX_GPIO_CLK_ENABLE() 	__HAL_RCC_GPIOG_CLK_ENABLE()
...
#define FDCANx_TX_PIN       			GPIO_PIN_11
#define FDCANx_TX_GPIO_PORT 			GPIOG
#define FDCANx_TX_AF        			GPIO_AF7_FDCAN1
#define FDCANx_RX_PIN       			GPIO_PIN_12
#define FDCANx_RX_GPIO_PORT 			GPIOG
#define FDCANx_RX_AF        			GPIO_AF7_FDCAN1
