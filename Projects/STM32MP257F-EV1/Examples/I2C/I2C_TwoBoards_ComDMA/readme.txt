...
In a first step after the user press the USER2 push-button on the Master Board,
...
The second step starts when the user press once again the USER2 push-button on the Master Board,
...
STM32MP257F-EV1's LED can be used to monitor the transfer status (after USER2 button has beeen pressed twice):
...
@par Directory contents 
  ...
  - I2C/I2C_TwoBoards_ComDMA/CM33/NonSecure/Inc/stm32mp2xx_hal_conf.h    HAL configuration file
  - I2C/I2C_TwoBoards_ComDMA/CM33/NonSecure/Inc/stm32mp2xx_it.h          DMA and I2C interrupt handlers header file
  - I2C/I2C_TwoBoards_ComDMA/CM33/NonSecure/Inc/main.h                   Header for main.c module  
  - I2C/I2C_TwoBoards_ComDMA/CM33/NonSecure/Src/stm32mp2xx_it.c          DMA and I2C interrupt handlers
  - I2C/I2C_TwoBoards_ComDMA/CM33/NonSecure/Src/main.c                   Main program
  - I2C/I2C_TwoBoards_ComDMA/CM33/NonSecure/Src/system_stm32mp2xx.c      STM32MP2xx system source file
  - I2C/I2C_TwoBoards_ComDMA/CM33/NonSecure/Src/stm32mp2xx_hal_msp.c     HAL MSP file    
...
- ssh root@192.168.7.1 'mkdir -p /home/root/I2C_TwoBoards_ComDMA/lib/firmware'
- scp the signed firmware I2C_TwoBoards_ComDMA_CM33_NonSecure_sign.bin to root@192.168.7.1:/home/root/I2C_TwoBoards_ComDMA/lib/firmware
- scp the script Firmware/Utilities/scripts/fw_cortex_m33.sh to root@192.168.7.1:/home/root/I2C_TwoBoards_ComDMA/
- To run the example on target: 
	On target shell run:
	- cd /home/root/I2C_TwoBoards_ComDMA
