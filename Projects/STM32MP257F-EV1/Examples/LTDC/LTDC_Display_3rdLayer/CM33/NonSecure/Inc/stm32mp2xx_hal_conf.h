...
/**
  * @brief In the following line adjust the Internal High Speed oscillator (HSE) Startup
  *        Timeout value
  */
...
#include "stm32mp2xx_hal_wrapper_for_a35.h"
  ...
  #include "stm32mp2xx_hal_flash.h"
 ...
 #include "stm32mp2xx_hal_cryp_saes.h"
 ...
 #include "stm32mp2xx_hal_tmpsens.h"
