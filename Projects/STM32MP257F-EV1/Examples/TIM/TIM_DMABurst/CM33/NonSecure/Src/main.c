...
static void MX_TIM8_Init(void)
{
  ...
  /* Acquire GPIO Pin PJ4 ---> TIM8_CH4 using Resource Manager */
...
static void MX_TIM8_DeInit(void)
{
  ...
  /*Release the HPDMA3, TIM8 and GPIO PJ4 using the Resource Manager */
  ...
  (void) ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOJ, RESMGR_GPIO_PIN(4));
}
