...
Clock setup for TIM12

================================

  TIM12CLK = 2*PCLK2 = 200 MHz.
  
  Prescaler = (TIM12CLK /TIM12 counter clock) - 1
  
  The prescaler value is computed in order to have TIM12 counter clock 
  set at 20000000 Hz.
  
  The Autoreload value is 65535 (TIM12->ARR), so the maximum frequency value to 
  trigger the TIM12 input is 20000000/65535 [Hz].
 
Configuration of TIM12 in One Pulse Mode
===================================================
 
  - The external signal is connected to TIM12_CH2 pin (PB.11), 
    and a rising edge on this input is used to trigger the Timer.
  - The One Pulse signal is output on TIM12_CH1 (PB.7).
...
STM32MP257F-EV1's LED can be used to monitor the status:
...
@par Hardware and Software environment
  ...
  - STM32MP257F-EV1 Set-up
    - Connect the external signal to the TIM12_CH2 pin (PB.11) (pin 31 in CN5 connector)
    - Connect the TIM12_CH1 pin(PB.7) (pin 23 in CN5 connector) to an oscilloscope to monitor the waveform. 
