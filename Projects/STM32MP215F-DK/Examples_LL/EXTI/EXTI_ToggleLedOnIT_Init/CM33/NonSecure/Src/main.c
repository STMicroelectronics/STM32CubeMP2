...
/**
  ******************************************************************************
  * @file    Examples_LL/EXTI/EXTI_ToggleLedOnIT_Init/CM33/NonSecure/Src/main.c
...
void LED_DeInit(void)
{
  ...
  (void) ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOH, RESMGR_GPIO_PIN(12));
}
