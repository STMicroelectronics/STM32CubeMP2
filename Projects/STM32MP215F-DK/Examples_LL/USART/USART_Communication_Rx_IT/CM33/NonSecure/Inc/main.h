...
#define LED3_LL_PIN                           		LL_GPIO_PIN_12
#define LED3_LL_GPIO_PORT                     		GPIOH
#define LED3_LL_GPIO_CLK_ENABLE()             		LL_RCC_GPIOH_EnableClock()
...
#define USER2_BUTTON_PIN                        LL_GPIO_PIN_7
#define USER2_BUTTON_GPIO_PORT                  GPIOF
#define USER2_BUTTON_GPIO_CLK_ENABLE()			LL_RCC_GPIOF_EnableClock()
#define USER2_BUTTON_EXTI_LINE                  LL_EXTI2_LINE_7
#define USER2_BUTTON_EXTI_IRQn                  EXTI2_7_IRQn
...
#define USER2_BUTTON_IRQHANDLER                 EXTI2_7_IRQHandler
