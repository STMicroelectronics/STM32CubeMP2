...
static const SSD1306_Comm_t* ssd1306_comm = NULL;
...
void ssd1306_WriteCommand(uint8_t byte) {
    if (ssd1306_comm && ssd1306_comm->WriteCommand)
        ssd1306_comm->WriteCommand(byte);
}

void ssd1306_WriteData(uint8_t* buffer, size_t buff_size) {
    if (ssd1306_comm && ssd1306_comm->WriteData)
        ssd1306_comm->WriteData(buffer, buff_size);
}

void ssd1306_Reset(void) {
    if (ssd1306_comm && ssd1306_comm->Reset)
        ssd1306_comm->Reset();
}
