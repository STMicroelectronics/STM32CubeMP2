...
- cd build && python ../../../../../Utilities/optee_os/scripts/sign_rproc_fw.py --in OpenAMP_TTY_echo_CM33_NonSecure_stripped.elf --out OpenAMP_TTY_echo_CM33_NonSecure_sign.bin --key ../../../../../Utilities/optee_os/keys/default.pem --plat-tlv BOOTADDR 0x80100000 && cd ..

Output:
- Elf Binary: `OpenAMP_TTY_echo_CM33_NonSecure.elf` in build folder
