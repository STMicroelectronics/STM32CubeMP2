...
two boards via DMA.
     ...
     |       |     SPI1               |           |        SPI1            |       |
     |       |                        |           |                        |       |
     |       |MOSI(PI5)   CN10.D19    |___________|MOSI(PI5)   CN10.D19    |       |
     |       |                        |           |                        |       |
     |       |MISO(PD1)   CN10.D21    |___________|MISO(PD1)   CN10.D21    |       |
     |       |                        |           |                        |       |
     |       |CLK(PD11)   CN10.D23    |___________|CLK(PD11)   CN10.D23    |       |
     |       |                        |           |                        |       |
     |       |NSS(PD2)    CN10.D24    |___________|NSS(PD2)    CN10.D24    |       |
     |       |                        |           |                        |       |
     |       |________________________|           |________________________|       |
     |   __                           |           |                                |
     |  |__|                          |           |                                |
     ...
     |                             GND|___________|GND                             |
     |                                |           |                                |
     |_______STM32MP2 Master__________|           |________STM32MP2 Slave__________|
...
In a first step after the user press the User push-button (USER2), SPI Master starts the
...
      Please refer to the AN4839 "Level 1 cache on STM32MP21 Series"
...
@par Directory contents 
  ...
  - SPI/SPI_FullDuplex_ComDMA/CM33/NonSecure/Inc/stm32mp215f_disco_conf.h BSP configuration file
...
@par Hardware and Software environment
  ...
  - STM32MP215-DK/STM32MP215-DK Set-up
    - Connect Master board's MOSI (PI5)  CN10.Pin-19 to Slave Board's MOSI (PI5)  CN10.Pin-19
    - Connect Master board's MISO (PD1)  CN10.Pin-21 to Slave Board's MISO (PD1)  CN10.Pin-21
    - Connect Master board's CLK  (PD11) CN10.Pin-23 to Slave Board's CLK  (PD11) CN10.Pin-23
    - Connect Master board's NSS  (PD2)  CN10.Pin-24 to Slave Board's NSS  (PD2)  CN10.Pin-24
