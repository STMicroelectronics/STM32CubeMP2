...
void MX_SPI_DeInit(void)
{
	...
	ResMgr_Release(RESMGR_RESOURCE_RIFSC, STM32MP21_RIFSC_SPI1_ID);

	/* Release GPIOB10 using Resource manager */
	ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOD, RESMGR_GPIO_PIN(1));

	/* Release GPIOB8 using Resource manager */
	ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOD, RESMGR_GPIO_PIN(2));

	/* Release GPIOB7 using Resource manager */
	ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOD, RESMGR_GPIO_PIN(11));
