...
/**
  * @brief  This function handles HPDMA3 exception.
  * @param  None
  * @retval None
  */
void HPDMA3_Channel1_IRQHandler(void)
{
  /* USER CODE BEGIN HPDMA3_IRQHandler 0 */

  /* USER CODE END HPDMA3_IRQHandler 0 */
  HAL_DMA_IRQHandler(hcryp.hdmain);
  /* USER CODE BEGIN HPDMA3_IRQHandler 1 */

  /* USER CODE END HPDMA3_IRQHandler 1 */
}
