/**
  ...
  * @file    LPTIM/LPTIM_PulseCounter/readme_cm33.txt
...
is generated, and LED3 toggles to indicate the last state.

In this example Period value is set to 1000, so each time the counter counts
(1000 + 1) rising edges on LPTIM2-Input1 (Pin PA2 / CN10->Pin3), an interrupt is generated and LED3
toggles.
...
@par Hardware and Software environment
  ...
  - Generate pulses on PA2 (pin 3 in CN5 connector). (that is Connect a square waveform).
