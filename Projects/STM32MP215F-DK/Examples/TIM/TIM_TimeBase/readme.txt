/**
  ...
  * @brief   This sample code demonstrates how to use the TIM HAL API to configure
  *          a timer to generate periodic interrupts and toggle an LED.
  ******************************************************************************
  *
...
The TIM5 ARR register value is equal to 10000 - 1,
Update rate = TIM5 counter clock / (Period + 1) = 1 Hz,
So the TIM5 generates an interrupt each 1 s

When the counter value reaches the auto-reload register value, the TIM update
interrupt is generated and, in the handler routine, LED3 on board STM32MP215F-DK
