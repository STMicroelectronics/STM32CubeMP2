...
int main(void)
{
  ...
  HAL_DCACHE_CleanByAddr(&hdcache, (uint32_t*)aTxBuffer, sizeof(aTxBuffer));
#endif /* ICACHE_DCACHE_ENABLE */
...
static void MX_I2C1_DeInit(void)
{
  ...
  ResMgr_Release(RESMGR_RESOURCE_RIFSC, RESMGR_RIFSC_I2C1_ID);
...
{
  /* Deinitialize the I2C1 peripheral and Resources*/
  MX_I2C1_DeInit();
