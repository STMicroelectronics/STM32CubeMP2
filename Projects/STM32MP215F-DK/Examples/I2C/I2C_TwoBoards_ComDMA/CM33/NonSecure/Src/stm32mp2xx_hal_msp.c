...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  if(I2C1 == hi2c->Instance)
  {
    ...
    {
      HAL_DMA_ConfigChannelAttributes(hi2c->hdmatx, (DMA_CHANNEL_PRIV | DMA_CHANNEL_SEC | DMA_CHANNEL_DEST_SEC |\
    ...
    if (IS_DEVELOPER_BOOT_MODE())
    {
      HAL_DMA_ConfigChannelAttributes(hi2c->hdmarx, (DMA_CHANNEL_PRIV | DMA_CHANNEL_SEC | DMA_CHANNEL_DEST_SEC |\
    		                                         DMA_CHANNEL_SRC_SEC | DMA_CHANNEL_CID_STATIC_2));
    }
    /* I2C1 interrupt Init */
