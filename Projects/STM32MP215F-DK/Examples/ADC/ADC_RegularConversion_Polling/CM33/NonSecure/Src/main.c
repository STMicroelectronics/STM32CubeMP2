...
static void MX_ADC2_DeInit(void)
{
	...
	(void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, STM32MP21_RIFSC_ADC2_ID);
	(void)ResMgr_Release(RESMGR_RESOURCE_RIF_PWR, RESMGR_PWR_RESOURCE(0));
	...
	(void)ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOF, RESMGR_GPIO_PIN(11));
}
