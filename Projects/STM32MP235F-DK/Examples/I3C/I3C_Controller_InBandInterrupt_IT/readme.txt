...
How to handle an In-Band-Interrupt event between an I3C Controller and I3C Targets
      ...
      - Board: STM32MP257F-DK's (embeds a STM32MP257FAIx device)
...
STM32MP257F-DK's LEDs can be used to monitor the transfer status:

 - LED3 will toggle each time an In-Band-Interrupt process is completed.
 - LED3 will toggle slowly when there is an error in In-Band-Interrupt process.
...
@par Directory contents
  ...
  - I3C/I3C_Controller_InBandInterrupt_IT/CM33/NonSecure/Inc/stm32mp257f_eval_conf.h    BSP configuration file
