...
static void MX_LPTIM4_Init(void)
{
	...
	if (RESMGR_STATUS_ACCESS_OK != ResMgr_Request(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_LPTIM4_ID))
	{
		Error_Handler();
	}
...
static void MX_LPTIM4_DeInit(void)
{
    ...
    (void) ResMgr_Release(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_LPTIM4_ID);
}
