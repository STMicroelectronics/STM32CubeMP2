...
/**
  * @brief  Function to deinitialize the cable detection state machine
  * @param  PortNum       Port number
  * @retval None
  */
void CAD_DeInit(uint8_t PortNum)
{

  HW_SignalDetachment(PortNum);

  /* Deinit power */
  BSP_USBPD_PWR_Deinit(PortNum);

#ifdef _LOW_POWER
  LL_UCPD_WakeUpDisable(Ports[PortNum].husbpd);
#endif /* _LOW_POWER */
