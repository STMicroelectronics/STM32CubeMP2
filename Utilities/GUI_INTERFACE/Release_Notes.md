...
<label for="collapse-section22" aria-hidden="true">V2.2.2 / 23-March-2022</label>
<div>
...
**Fixed bugs list**
  ...
  Headline
  --------
  Adaptation of flash erase structure field to support new flash
  MCUAstyle corrections
  Solve potential compilation warnings in Send_DpmConfigSetCnf()
...
<label for="collapse-section21" aria-hidden="true">V2.2.1 / 23-December-2021</label>
<div>
...
**Fixed bugs list**
  ...
  Headline
  --------
  MCUAstyle and Codespell corrections
  Solve potential compilation warnings in GUI_InitOS()
