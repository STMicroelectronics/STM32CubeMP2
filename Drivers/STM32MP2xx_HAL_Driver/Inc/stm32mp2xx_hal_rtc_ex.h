...
#ifndef __STM32MP2xx_HAL_RTC_EX_H
#define __STM32MP2xx_HAL_RTC_EX_H
...
typedef struct
{
  uint32_t rtcSecureFull;             /*!< Specifies If the RTC is fully secured or not
                                           This parameter can be a value of @ref RTCEx_RTC_Secure_Full */

  uint32_t rtcSecureFeatures;         /*!< Specifies the secured features.
                                           This parameter is only relevant if RTC is not fully secured
                                           (rtcSecureFull == RTC_SECURE_FULL_NO).
                                           This parameter can be a combination of @ref RTCEx_RTC_Secure_Features. */

  uint32_t tampSecureFull;            /*!< Specifies If the TAMP is fully secured or not execpt monotonic counters and
                                           BackUp registers.
  ...
  uint32_t MonotonicCounterSecure;    /*!< Specifies If the monotonic counter 1 is secured or not
                                           This parameter can be a value of @ref RTCEx_TAMP_Monotonic_Counter_Secure */

  uint32_t MonotonicCounter2Secure;   /*!< Specifies If the monotonic counter 2 is secured or not
                                           This parameter can be a value of @ref RTCEx_TAMP_Monotonic_Counter2_Secure */
...
typedef struct
{
  ...
  uint32_t tampPrivilegeFull;           /*!< Specifies If the TAMP is fully privileged or not execpt monotonic counters
  ...
  uint32_t backupRegisterPrivZone;      /*!< Specifies backup register zone to be privileged.
                                             ...
                                             Warning : this parameter is writable in secure mode or
                                                       if trustzone is disabled. */
  ...
  uint32_t MonotonicCounter2Privilege;  /*!< Specifies If the monotonic counter 2 is privileged or not
                                             This parameter can be a value of
                                             @ref RTCEx_TAMP_Monotonic_Counter2_Privilege */
} RTC_PrivilegeStateTypeDef;
/**
  * @}
  */

/** @defgroup RTCEx_Cid_State_structure_definition RTCEx CID structure definition
  * @{
  */
typedef struct
{
  uint32_t rtcCidAlrA;                 /*!< Specifies RTC Alarm A CID.
                                             This parameter can be a combination of @ref RTCEx_RTC_CID. */

  uint32_t rtcCidAlrB;                 /*!< Specifies RTC Alarm B CID.
                                             This parameter can be a combination of @ref RTCEx_RTC_CID. */

  uint32_t rtcCidWut;                  /*!< Specifies RTC Wakeup Timer CID.
                                             This parameter can be a combination of @ref RTCEx_RTC_CID. */

  uint32_t rtcCidTs;                   /*!< Specifies RTC Timestamp CID.
                                             This parameter can be a combination of @ref RTCEx_RTC_CID. */

  uint32_t rtcCidInit;                 /*!< Specifies RTC Initialization CID.
                                             This parameter can be a combination of @ref RTCEx_RTC_CID. */

  uint32_t rtcCidCal;                  /*!< Specifies RTC Calibration CID.
                                             This parameter can be a combination of @ref RTCEx_RTC_CID. */

  uint32_t tampCidTampBk0;             /*!< Specifies TAMP and backup registers CID region 0.
                                             This parameter can be a combination of @ref RTCEx_TAMP_CID. */

  uint32_t tampCidMon1Bk1;             /*!< Specifies TAMP Monotonic counter 1 and backup registers CID region 1.
                                             This parameter can be a combination of @ref RTCEx_TAMP_CID. */

  uint32_t tampCidMon2Bk2;             /*!< Specifies TAMP Monotonic counter 2 and backup registers CID region 2.
                                             This parameter can be a combination of @ref RTCEx_TAMP_CID. */
  ...
  uint32_t backupRegisterStartRif2Zone1;    /*!< Specifies the backup register start RIF 2 protection zone 1.
                                             Protection zone 3-RIF0: (Non-secure read Non-secure write)
                                             Protection zone 1-RIF1: (Secure read Secure write)
                                             Protection zone 2-RIF1: (Non-secure read Secure write)
                                             Protection zone 3-RIF1: (Non-secure read Non-secure write)
                                             Protection zone 1-RIF2: (Secure read Secure write)
                                             Protection zone 2-RIF2: (Non-secure read Secure write)
                                             Protection zone 3-RIF2: (Non-secure read Non-secure write)
                                             This parameter can be RTC_BKP_DRx where x can be from 0 to 31 to
                                             specify the register. */

  uint32_t backupRegisterStartRif2Zone2;    /*!< Specifies the backup register start RIF 2 protection zone 2.
                                             Protection zone 3-RIF0: (Non-secure read Non-secure write)
                                             Protection zone 1-RIF1: (Secure read Secure write)
                                             Protection zone 2-RIF1: (Non-secure read Secure write)
                                             Protection zone 3-RIF1: (Non-secure read Non-secure write)
  ...
  uint32_t backupRegisterStartRif0Zone3;    /*!< Specifies the backup register start RIF 0 protection zone 3.
                                             Protection zone 3-RIF0: (Non-secure read Non-secure write)
                                             Protection zone 1-RIF1: (Secure read Secure write)
                                             Protection zone 2-RIF1: (Non-secure read Secure write)
                                             Protection zone 3-RIF1: (Non-secure read Non-secure write)
  ...
  uint32_t backupRegisterStartRif2Zone3;    /*!< Specifies the backup register start RIF 2 protection zone 3.
                                             Protection zone 3-RIF0: (Non-secure read Non-secure write)
                                             Protection zone 1-RIF1: (Secure read Secure write)
                                             Protection zone 2-RIF1: (Non-secure read Secure write)
                                             Protection zone 3-RIF1: (Non-secure read Non-secure write)
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096   (TAMP_FLTCR_TAMPFREQ_0 | \
                                                 TAMP_FLTCR_TAMPFREQ_1)     /*!< Each of the tamper inputs are sampled with a frequency = RTCCLK / 4096  */
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV1024   (TAMP_FLTCR_TAMPFREQ_0 | \
                                                 TAMP_FLTCR_TAMPFREQ_2)     /*!< Each of the tamper inputs are sampled with a frequency = RTCCLK / 1024  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512    (TAMP_FLTCR_TAMPFREQ_1 | \
                                                 TAMP_FLTCR_TAMPFREQ_2)     /*!< Each of the tamper inputs are sampled with a frequency = RTCCLK / 512   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256    (TAMP_FLTCR_TAMPFREQ_0 | \
...
#define RTC_MONOTONIC_COUNTER_2           1u   /*!< Monotonic counter 1 */
...
/** @defgroup RTCEx_Binary_mix_BCDU If Binary mode is RTC_BINARY_MIX, the BCD calendar second is
  *           incremented using the SSR Least Significant Bits.
  * @{
  */
...
/** @defgroup RTCEx_Alarm_Sub_Seconds_binary_Clear_Definitions RTC Alarm Sub Seconds with
  *           binary mode auto clear Definitions
  * @{
  */
#define RTC_ALARMSUBSECONDBIN_AUTOCLR_NO   0UL                /*!< The synchronous Binary counter (SS[31:0] in RTC_SSR) is free-running. */
#define RTC_ALARMSUBSECONDBIN_AUTOCLR_YES  RTC_ALRMASSR_SSCLR /*!< The synchronous Binary counter (SS[31:0] in RTC_SSR)
                                                                   is running from 0xFFFFFFFF to RTC_ALRMABINR->SS[31:0]
                                                                   value and is automatically reloaded with 0xFFFFFFFF
...
/** @defgroup RTCEx_RTC_Secure_Features  RTCEx Secure Features Definition
  * @{
  */

#define RTC_SECURE_FEATURE_NONE            0u
#define RTC_SECURE_FEATURE_INIT            RTC_SECCFGR_INITSEC  /*!< Initialization */
#define RTC_SECURE_FEATURE_CAL             RTC_SECCFGR_CALSEC   /*!< Calibration */
#define RTC_SECURE_FEATURE_TS              RTC_SECCFGR_TSSEC    /*!< Time stamp */
#define RTC_SECURE_FEATURE_WUT             RTC_SECCFGR_WUTSEC   /*!< Wake up timer */
#define RTC_SECURE_FEATURE_ALRA            RTC_SECCFGR_ALRASEC  /*!< Alarm A */
#define RTC_SECURE_FEATURE_ALRB            RTC_SECCFGR_ALRBSEC  /*!< Alarm B */
#define RTC_SECURE_FEATURE_ALL             (RTC_SECCFGR_INITSEC |  RTC_SECCFGR_CALSEC | \
...
/** @defgroup RTCEx_TAMP_Monotonic_Counter_Secure  RTCEx TAMP Monotonic Counter 1 Secure Definition
  * @{
  */
#define TAMP_MONOTONIC_CNT_SECURE_YES                 TAMP_SECCFGR_CNT1SEC      /*!< TAMPER Monotonic Counter 1 secure */
#define TAMP_MONOTONIC_CNT_SECURE_NO                  0u                        /*!< TAMPER Monotonic Counter 1 is not secure */
/**
  * @}
  */

/** @defgroup RTCEx_TAMP_Monotonic_Counter2_Secure  RTCEx TAMP Monotonic Counter 2 Secure Definition
  * @{
  */
#define TAMP_MONOTONIC_CNT2_SECURE_YES                TAMP_SECCFGR_CNT2SEC      /*!< TAMPER Monotonic Counter 2 secure */
#define TAMP_MONOTONIC_CNT2_SECURE_NO                 0u                        /*!< TAMPER Monotonic Counter 2 is not secure */
/**
  * @}
  */
...
/** @defgroup RTCEx_TAMP_Monotonic_Counter_Privilege  RTCEx TAMP Monotonic Counter 1 Privilege Definition
  * @{
  */
#define TAMP_MONOTONIC_CNT_PRIVILEGE_YES     TAMP_PRIVCR_CNT1PRIV
#define TAMP_MONOTONIC_CNT_PRIVILEGE_NO      0u
/**
  * @}
  */

/** @defgroup RTCEx_TAMP_Monotonic_Counter2_Privilege  RTCEx TAMP Monotonic Counter 2 Privilege Definition
  * @{
  */
#define TAMP_MONOTONIC_CNT2_PRIVILEGE_YES    TAMP_PRIVCR_CNT2PRIV
#define TAMP_MONOTONIC_CNT2_PRIVILEGE_NO     0u
/**
  * @}
  */
...
/** @defgroup RTCEx_RTC_CID  RTCEx CID Definition
  * @{
  */
#define RTC_CID_DISABLE                      (0x80000000u)
#define RTC_CID_0                            (0u << RTC_RCIDCFGR_CID_Pos)
#define RTC_CID_1                            (1u << RTC_RCIDCFGR_CID_Pos)
#define RTC_CID_2                            (2u << RTC_RCIDCFGR_CID_Pos)
#define RTC_CID_3                            (3u << RTC_RCIDCFGR_CID_Pos)
/**
  * @}
  */

/** @defgroup RTCEx_TAMP_CID  RTCEx TAMP CID Definition
  * @{
  */
#define TAMP_CID_DISABLE                     (0x80000000u)
#define TAMP_CID_0                           (0u << TAMP_RCIDCFGR_CID_Pos)
#define TAMP_CID_1                           (1u << TAMP_RCIDCFGR_CID_Pos)
#define TAMP_CID_2                           (2u << TAMP_RCIDCFGR_CID_Pos)
#define TAMP_CID_3                           (3u << TAMP_RCIDCFGR_CID_Pos)
/**
  * @}
  */
...
#define __HAL_RTC_GET_FLAG(__HANDLE__, __FLAG__)    ( \
                                                      ((((__FLAG__)) >> 8U) == 1U)                                   \
                                                      ?                                                              \
                                                      (RTC->ICSR & (1U << (((uint16_t)(__FLAG__)) & RTC_IT_MASK)))   \
                                                      :                                                              \
...
#define EXTIn_Cx EXTI2_C1
#elif defined (CORE_CM33)
#define EXTIn_Cx EXTI2_C2
#elif defined (CORE_CM0PLUS)
#define EXTIn_Cx EXTI2_C3
#endif /* COREs */

#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_IT()       (EXTIn_Cx->IMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)

/**
  * @brief  Disable interrupt on the RTC WakeUp Timer associated Exti line.
  * @retval None
  */
#define __HAL_RTC_WAKEUPTIMER_EXTI_DISABLE_IT()      (EXTIn_Cx->IMR1 &= ~(RTC_EXTI_LINE_WAKEUPTIMER_EVENT))

/**
  * @brief  Enable event on the RTC WakeUp Timer associated Exti line.
  * @retval None
  */
#define __HAL_RTC_WAKEUPTIMER_EXTI_ENABLE_EVENT()    (EXTIn_Cx->EMR1 |= RTC_EXTI_LINE_WAKEUPTIMER_EVENT)

/**
  * @brief  Disable event on the RTC WakeUp Timer associated Exti line.
  * @retval None
  */
#define __HAL_RTC_WAKEUPTIMER_EXTI_DISABLE_EVENT()   (EXTIn_Cx->EMR1 &= ~(RTC_EXTI_LINE_WAKEUPTIMER_EVENT))
...
/**
  ...
  * @retval None
  */
#define __HAL_RTC_TIMESTAMP_EXTI_ENABLE_IT()       (EXTIn_Cx->IMR1 |= RTC_EXTI_LINE_TIMESTAMP_EVENT)

/**
  * @brief  Disable interrupt on the RTC Timestamp associated Exti line.
  * @retval None
  */
#define __HAL_RTC_TIMESTAMP_EXTI_DISABLE_IT()       (EXTIn_Cx->IMR1 &= ~(RTC_EXTI_LINE_TIMESTAMP_EVENT))

/**
  * @brief  Enable event on the RTC Timestamp associated Exti line.
  * @retval None
  */
#define __HAL_RTC_TIMESTAMP_EXTI_ENABLE_EVENT()    (EXTIn_Cx->EMR1 |= RTC_EXTI_LINE_TIMESTAMP_EVENT)

/**
  * @brief  Disable event on the RTC Timestamp associated Exti line.
  * @retval None
  */
#define __HAL_RTC_TIMESTAMP_EXTI_DISABLE_EVENT()   (EXTIn_Cx->EMR1 &= ~(RTC_EXTI_LINE_TIMESTAMP_EVENT))
...
/**
  ...
  *            @arg  RTC_IT_INT_TAMP_10: Internal Tamper10 interrupt
...
/**
  ...
  *            @arg  RTC_IT_INT_TAMP_8: Internal Tamper8 interrupt
  *            @arg  RTC_IT_INT_TAMP_9: Internal Tamper9 interrupt
  *            @arg  RTC_IT_INT_TAMP_11: Internal Tamper10 interrupt
  *            @arg  RTC_IT_INT_TAMP_11: Internal Tamper11 interrupt
  * @retval None
  */
...
/**
  ...
  * @retval None
  */
#define __HAL_RTC_TAMPER_EXTI_ENABLE_IT()        (EXTIn_Cx->IMR1 |= RTC_EXTI_LINE_TAMPER_EVENT)

/**
  * @brief  Disable interrupt on the RTC tamper associated Exti line.
  * @retval None
  */
#define __HAL_RTC_TAMPER_EXTI_DISABLE_IT()       (EXTIn_Cx->IMR1 &= ~(RTC_EXTI_LINE_TAMPER_EVENT))

/**
  * @brief  Enable event on the RTC tamper associated Exti line.
  * @retval None
  */
#define __HAL_RTC_TAMPER_EXTI_ENABLE_EVENT()    (EXTIn_Cx->EMR1 |= RTC_EXTI_LINE_TAMPER_EVENT)

/**
  * @brief  Disable event on the RTC tamper associated Exti line.
  * @retval None
  */
#define __HAL_RTC_TAMPER_EXTI_DISABLE_EVENT()   (EXTIn_Cx->EMR1 &= ~(RTC_EXTI_LINE_TAMPER_EVENT))
...
/**
  ...
  * @retval None
  */
#define __HAL_RTC_SSRU_EXTI_ENABLE_IT()       (EXTIn_Cx->IMR1 |= RTC_EXTI_LINE_SSRU_EVENT)

/**
  * @brief  Disable interrupt on the RTC SSR Underflow associated Exti line.
  * @retval None
  */
#define __HAL_RTC_SSRU_EXTI_DISABLE_IT()      (EXTIn_Cx->IMR1 &= ~(RTC_EXTI_LINE_SSRU_EVENT))

/**
  * @brief  Enable event on the RTC SSR Underflow associated Exti line.
  * @retval None
  */
#define __HAL_RTC_SSRU_EXTI_ENABLE_EVENT()    (EXTIn_Cx->EMR1 |= RTC_EXTI_LINE_SSRU_EVENT)

/**
  * @brief  Disable event on the RTC SSR Underflow associated Exti line.
  * @retval None
  */
#define __HAL_RTC_SSRU_EXTI_DISABLE_EVENT()   (EXTIn_Cx->EMR1 &= ~(RTC_EXTI_LINE_SSRU_EVENT))
...
void              HAL_RTCEx_SSRUIRQHandler_S(RTC_HandleTypeDef *hrtc);
void              HAL_RTCEx_SSRUEventCallback_S(RTC_HandleTypeDef *hrtc);
...
#if defined (CORE_CA35)
#define RTC_EXTI_LINE_TIMESTAMP_EVENT         EXTI2_IMR1_IM22 /*!< External interrupt line 17 Connected to the RTC Time Stamp events */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT       EXTI2_IMR1_IM22 /*!< External interrupt line 17 Connected to the RTC Wakeup event */
#define RTC_EXTI_LINE_TAMPER_EVENT            EXTI2_IMR1_IM21 /*!< External interrupt line 19 Connected to the RTC tamper events */
#define RTC_EXTI_LINE_SSRU_EVENT              EXTI2_IMR1_IM22 /*!< External interrupt line 18 Connected to the RTC SSR Underflow event  */
#elif defined (CORE_CM33)
#define RTC_EXTI_LINE_TIMESTAMP_EVENT         EXTI2_IMR1_IM24 /*!< External interrupt line 22 Connected to the RTC Time Stamp events */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT       EXTI2_IMR1_IM24 /*!< External interrupt line 22 Connected to the RTC Wakeup event */
#define RTC_EXTI_LINE_TAMPER_EVENT            EXTI2_IMR1_IM23 /*!< External interrupt line 23 Connected to the RTC tamper events */
#define RTC_EXTI_LINE_SSRU_EVENT              EXTI2_IMR1_IM24 /*!< External interrupt line 22 Connected to the RTC SSR Underflow event  */
#endif /* COREs */
#else /* Non secure state */
#if defined (CORE_CA35)
#define RTC_EXTI_LINE_TIMESTAMP_EVENT         EXTI2_IMR1_IM17 /*!< External interrupt line 17 Connected to the RTC Time Stamp events */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT       EXTI2_IMR1_IM17 /*!< External interrupt line 17 Connected to the RTC Wakeup event */
#define RTC_EXTI_LINE_TAMPER_EVENT            EXTI2_IMR1_IM16 /*!< External interrupt line 19 Connected to the RTC tamper events */
#define RTC_EXTI_LINE_SSRU_EVENT              EXTI2_IMR1_IM17 /*!< External interrupt line 18 Connected to the RTC SSR Underflow event  */
#elif defined (CORE_CM33)
#define RTC_EXTI_LINE_TIMESTAMP_EVENT         EXTI2_IMR1_IM19 /*!< External interrupt line 22 Connected to the RTC Time Stamp events */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT       EXTI2_IMR1_IM18 /*!< External interrupt line 22 Connected to the RTC Wakeup event */
#define RTC_EXTI_LINE_TAMPER_EVENT            EXTI2_IMR1_IM19 /*!< External interrupt line 23 Connected to the RTC tamper events */
#define RTC_EXTI_LINE_SSRU_EVENT              EXTI2_IMR1_IM19 /*!< External interrupt line 22 Connected to the RTC SSR Underflow event  */
#elif defined (CORE_CM0PLUS)
#define RTC_EXTI_LINE_TIMESTAMP_EVENT         0 /*!< No RTC Time Stamp events it line for cpu 3 */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT       0 /*!< No RTC Wakeup event It line for cpu 3*/
#define RTC_EXTI_LINE_TAMPER_EVENT            EXTI2_IMR1_IM20 /*!< External interrupt line 19 Connected to the RTC tamper events */
#define RTC_EXTI_LINE_SSRU_EVENT              0 /*!< No RTC SSR Underflow It line for cpu 3 */
#endif /* COREs */
...
#define IS_TAMP_MONOTONIC_CNT2_SECURE(__STATE__) (((__STATE__) == TAMP_MONOTONIC_CNT2_SECURE_YES) || \
                                                  ((__STATE__) == TAMP_MONOTONIC_CNT2_SECURE_NO))
...
#define IS_TAMP_MONOTONIC_CNT2_PRIVILEGE(__STATE__) (((__STATE__) == TAMP_MONOTONIC_CNT2_PRIVILEGE_YES) || \
                                                     ((__STATE__) == TAMP_MONOTONIC_CNT2_PRIVILEGE_NO))

#define IS_RTC_CID(__STATE__) (((__STATE__) == RTC_CID_0) || \
                               ((__STATE__) == RTC_CID_1) || \
                               ((__STATE__) == RTC_CID_2) || \
                               ((__STATE__) == RTC_CID_3) || \
                               ((__STATE__) == RTC_CID_DISABLE))

#define IS_TAMP_CID(__STATE__) (((__STATE__) == TAMP_CID_0) || \
                                ((__STATE__) == TAMP_CID_1) || \
                                ((__STATE__) == TAMP_CID_2) || \
                                ((__STATE__) == TAMP_CID_3) || \
                                ((__STATE__) == TAMP_CID_DISABLE))
...
#define IS_RTC_ALARM_SUB_SECOND_BINARY_MASK(MASK)   ( \
                                                      ((MASK) == 0u)                                   \
                                                      ||                                               \
                                                      ( \
