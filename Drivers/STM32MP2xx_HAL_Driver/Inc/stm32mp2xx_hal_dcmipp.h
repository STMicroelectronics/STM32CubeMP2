...
typedef struct
{
  ...
  uint32_t PHYBitrate;        /*!< Configures the Phy Bitrate
                                   This parameter can be a value from @ref DCMIPP_CSI_PHY_BitRate     */
...
typedef struct
{
  uint32_t Width;                                /*!< Configures the width of the visible pixels of generated frame.
                                                      This parameter can be one value between 16 and 16383.           */
  uint32_t Height;                               /*!< Configures the height of the visible pixels of generated frame.
                                                      This parameter can be one value up to 16383.                    */
  uint32_t VBL;                                  /*!< Configures the amount of lines of the vertical blanking.
                                                      This parameter can be one value between 16 and 65535.           */
  uint32_t Format;                               /*!< Configures the TPG pixel format.
                                                      This parameter can be a value of @ref DCMIPP_TPG_Format         */
  uint32_t RawBayerType;                         /*!< Configures the RAW Bayer type. It is required when Format is Raw.
                                                      This parameter can be a value of @ref DCMIPP_TPG_Raw_Bayer_Type */
  uint32_t YUVType;                              /*!< Configure the YUV type. It is required when Format is YUV.
                                                      This parameter can be a value of @ref DCMIPP_TPG_YUV_Type       */
  uint32_t Pattern;                              /*!< Configure the pattern of the TPG frames.
                                                      This parameter can be a value of @ref DCMIPP_TPG_Pattern        */
  uint32_t GreyScale;                            /*!< Enables or disable the Grey Scale.
                                                      This parameter can be a value of @ref DCMIPP_TPG_Grey_Scale     */
  uint32_t Lifeline;                             /*!< Enables or disable lifeline on TPG frames.
                                                      This parameter can be a value of @ref DCMIPP_TPG_Lifeline       */
} DCMIPP_TPGConfTypeDef;
...
typedef struct
{
  uint8_t ClampOutputSamples;  /*!< Clamp the output samples depending on type
...
/** @defgroup DCMIPP_TPG_Raw_Bayer_Type DCMIPP TPG Raw Bayer Type
  * @{
  */
#define DCMIPP_TPG_RT_RGGB    (0U)                           /*!< RGGB  */
#define DCMIPP_TPG_RT_GRBG    (1U << DCMIPP_CMTPGCR2_RT_Pos) /*!< GRBG  */
#define DCMIPP_TPG_RT_GBRG    (2U << DCMIPP_CMTPGCR2_RT_Pos) /*!< GBRG  */
#define DCMIPP_TPG_RT_BGGR    (3U << DCMIPP_CMTPGCR2_RT_Pos) /*!< BGGR  */
/**
  * @}
  */

/** @defgroup DCMIPP_TPG_YUV_Type DCMIPP TPG YUV Type
  * @{
  */
#define DCMIPP_TPG_YT_BT601_FULL       (0U)                            /*!< BT.601 Full range     */
#define DCMIPP_TPG_YT_BT709_FULL       (1U << DCMIPP_CMTPGCR2_YT_Pos)  /*!< BT.709 Full range     */
#define DCMIPP_TPG_YT_BT601_REDUCED    (2U << DCMIPP_CMTPGCR2_YT_Pos)  /*!< BT.601 Reduced range  */
#define DCMIPP_TPG_YT_BT709_REDUCED    (3U << DCMIPP_CMTPGCR2_YT_Pos)  /*!< BT.709 Reduced range  */
/**
  * @}
  */

/** @defgroup DCMIPP_TPG_Pattern DCMIPP TPG Pattern
  * @{
  */
#define DCMIPP_TPG_PATTERN_SQUARE        (0U)                                 /*!< Color squares */
#define DCMIPP_TPG_PATTERN_COLORBAR      (1U << DCMIPP_CMTPGCR2_PATTERN_Pos)  /*!< Color bar     */
/**
  * @}
  */

/** @defgroup DCMIPP_TPG_Grey_Scale DCMIPP TPG Grey Scale
  * @{
  */
#define DCMIPP_TPG_GREY_SCALE_DISABLE    (0U)                             /*!< Disable Grey Scale */
#define DCMIPP_TPG_GREY_SCALE_ENABLE     (1U << DCMIPP_CMTPGCR2_GSEN_Pos) /*!< Enable Grey Scale */
/**
  * @}
  */

/** @defgroup DCMIPP_TPG_Lifeline   DCMIPP TPG Lifeline
  * @{
  */
#define DCMIPP_TPG_LIFELINE_DISABLE       (0U)                               /*!< Disable Life Line */
#define DCMIPP_TPG_LIFELINE_ENABLE        (1U << DCMIPP_CMTPGCR2_LFLEN_Pos)  /*!< Enable Life Line */
/**
  * @}
  */
...
/**
  ...
  */
/**
  * @defgroup DCMIPP_CSI_PHY_BitRate DCMIPP CSI PHY BitRate
  * @{
  */
...
#define  DCMIPP_PIXEL_PACKER_FORMAT_YUV422_1_UYVY   (10U << DCMIPP_P1PPCR_FORMAT_Pos) /*!< YUV422 1-buffer 16bpp UYVY */
/**
  * @}
  */
...
#define IS_DCMIPP_TPG_WIDTH(WIDTH) (((WIDTH) >= 0x00010U) && ((WIDTH) <= 0xFFFFU))
#define IS_DCMIPP_TPG_HEIGHT(HEIGHT) ((HEIGHT) <= 0x3FFFU)
#define IS_DCMIPP_TPG_VBL(VBL) (((VBL) >= 0x00010U) && ((VBL) <= 0xFFFFU))
#define IS_DCMIPP_TPG_FORMAT(FORMAT) (((FORMAT) == DCMIPP_TPG_FORMAT_YUV422)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_RGB565)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_RGB888)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_RAW8)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_RAW10)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_RAW12)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_RAW14)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_MONO8)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_MONO10)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_MONO12)||\
                                      ((FORMAT) == DCMIPP_TPG_FORMAT_MONO14))
#define IS_DCMIPP_TPG_RAW_TYPE(RAW_TYPE) (((RAW_TYPE) == DCMIPP_TPG_RT_RGGB)||\
                                          ((RAW_TYPE) == DCMIPP_TPG_RT_GRBG)||\
                                          ((RAW_TYPE) == DCMIPP_TPG_RT_GBRG)||\
                                          ((RAW_TYPE) == DCMIPP_TPG_RT_BGGR))
#define IS_DCMIPP_TPG_YUV_TYPE(YUV_TYPE) (((YUV_TYPE) == DCMIPP_TPG_YT_BT601_FULL)||\
                                          ((YUV_TYPE) == DCMIPP_TPG_YT_BT709_FULL)||\
                                          ((YUV_TYPE) == DCMIPP_TPG_YT_BT601_REDUCED)||\
                                          ((YUV_TYPE) == DCMIPP_TPG_YT_BT709_REDUCED))
#define IS_DCMIPP_TPG_PATTERN(PATTERN) (((PATTERN) == DCMIPP_TPG_PATTERN_COLORBAR)||\
                                        ((PATTERN) == DCMIPP_TPG_PATTERN_SQUARE))
#define IS_DCMIPP_TPG_GREY_SCALE(GREY_SCALE) (((GREY_SCALE) == DCMIPP_TPG_GREY_SCALE_DISABLE)||\
                                              ((GREY_SCALE) == DCMIPP_TPG_GREY_SCALE_ENABLE))
#define IS_DCMIPP_TPG_LIFELINE(LIFELINE) (((LIFELINE) == DCMIPP_TPG_LIFELINE_DISABLE)||\
                                          ((LIFELINE) == DCMIPP_TPG_LIFELINE_ENABLE))
...
#define IS_DCMIPP_CLAMP_OUTPUT_SAMPLES(CLAMP_OUTPUT_SAMPLES) (((CLAMP_OUTPUT_SAMPLES) == (uint8_t)ENABLE) ||\
                                                              ((CLAMP_OUTPUT_SAMPLES) == (uint8_t)DISABLE))
