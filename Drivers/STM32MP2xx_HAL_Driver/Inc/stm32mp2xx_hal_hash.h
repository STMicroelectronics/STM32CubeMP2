...
#ifndef STM32MP2xx_HAL_HASH_H
#define STM32MP2xx_HAL_HASH_H
...
/** @addtogroup STM32MP2xx_HAL_Driver
  * @{
  */
#if defined (HASH) || defined (HASH1) || defined (HASH2)
/** @defgroup HASH HASH
...
#define IS_HASH_ALGORITHM(__ALGORITHM__) (((__ALGORITHM__) == HASH_ALGOSELECTION_SHA1)|| \
                                          ...
                                          ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA3_384)|| \
                                          ((__ALGORITHM__) == HASH_ALGOSELECTION_SHA3_512)|| \
                                          ((__ALGORITHM__) == HASH_ALGOSELECTION_SHAKE_128)|| \
                                          ((__ALGORITHM__) == HASH_ALGOSELECTION_SHAKE_256))
