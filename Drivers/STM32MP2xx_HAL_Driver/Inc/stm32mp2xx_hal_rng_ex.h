...
#ifndef STM32MP2xx_HAL_RNG_EX_H
#define STM32MP2xx_HAL_RNG_EX_H
...
typedef struct
{
  ...
  uint32_t        HealthTest[4];           /*!< RNG health test control must be a value
