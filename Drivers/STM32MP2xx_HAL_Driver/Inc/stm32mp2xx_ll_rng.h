...
#ifndef STM32MP2xx_LL_RNG_H
#define STM32MP2xx_LL_RNG_H
...
__STATIC_INLINE void LL_RNG_SetHealthConfig(RNG_TypeDef *RNGx, uint32_t HTCFG)
{
  ...
  WRITE_REG(RNGx->HTCR[1], 0x0000FFFF);
  WRITE_REG(RNGx->HTCR[2], 0x0000FFFF);
  WRITE_REG(RNGx->HTCR[3], 0x0000FFFF);
#else
