...
#ifndef STM32MP2xx_HAL_CRYP_H
#define STM32MP2xx_HAL_CRYP_H
...
#define CRYP_TDES_ECB             ((uint32_t)0x00000000)
#define CRYP_TDES_CBC             (CRYP_CR_ALGOMODE_0)
#define CRYP_DES_ECB              (CRYP_CR_ALGOMODE_1)
#define CRYP_DES_CBC              (CRYP_CR_ALGOMODE_0 | CRYP_CR_ALGOMODE_1)
...
#include "stm32mp2xx_hal_cryp_ex.h"
