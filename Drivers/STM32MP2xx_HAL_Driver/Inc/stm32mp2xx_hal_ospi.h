...
typedef struct
{
  uint32_t MuxEn;                    /*!< It indicates the state of OSPI IO Manager multiplexed mode.
                                        This parameter can be a value of @ref OSPIM_MuxEn */
  uint32_t Mode;                   /*!< It indicates the multiplexing mode of the OSPI IO Manager.
                                        This parameter can be a value of @ref OSPIM_Mode */
  uint32_t CSOvrEn;                /*!< It indicates the state of Chip Select Selector override.
                                        This parameter can be a value of @ref OSPIM_CSOvrEn */
  uint32_t CS1Ovr;                 /*!< It indicates the state of Chip Select Selector override setting for OCTOSPI1.
...
/** @defgroup OSPIM_MuxEn OSPI IO Manager Multiplexed mode enable
  * @{
  */
#define HAL_OSPIM_MUX_DISABLE              ((uint32_t)0x00000000U)
#define HAL_OSPIM_MUX_ENABLE               ((uint32_t)OCTOSPIM_CR_MUXEN)
/**
  * @}
  */

/** @defgroup OSPIM_Mode OSPI IO Manager multiplexing mode
  * @{
  */
#define HAL_OSPIM_MODE_DIRECT              ((uint32_t)0x00000000U)
#define HAL_OSPIM_MODE_SWAPPED             ((uint32_t)OCTOSPIM_CR_MODE)
/**
  * @}
  */

/** @defgroup OSPIM_CSOvrEn OSPI IO Manager Chip Select Selector override enable
  * @{
  */
#define HAL_OSPIM_CSSEL_OVR_DISABLE        ((uint32_t)0x00000000U)
#define HAL_OSPIM_CSSEL_OVR_ENABLE         ((uint32_t)OCTOSPIM_CR_CSSEL_OVR_EN)
/**
  * @}
  */

/** @defgroup OSPIM_CS1Ovr OSPI IO Manager Chip Select Selector override setting for OCTOSPI1
  * @{
  */
...
/** @defgroup OSPIM_CS2Ovr OSPI IO Manager Chip Select Selector override setting for OCTOSPI2
  * @{
  */
...
#define IS_OSPIM_MODE(MODE)                (((MODE) == HAL_OSPIM_MODE_DIRECT) || \
                                            ((MODE) == HAL_OSPIM_MODE_SWAPPED))
#define IS_OSPIM_CSOVREN(CSOVREN)          (((CSOVREN) == HAL_OSPIM_CSSEL_OVR_DISABLE) || \
                                            ((CSOVREN) == HAL_OSPIM_CSSEL_OVR_ENABLE))
#define IS_OSPIM_CS1OVR(CS1OVR)            (((CS1OVR) == HAL_OSPIM_CSSEL_OVR_01_NCS1) || \
                                            ((CS1OVR) == HAL_OSPIM_CSSEL_OVR_01_NCS2))
#define IS_OSPIM_CS2OVR(CS2OVR)            (((CS2OVR) == HAL_OSPIM_CSSEL_OVR_02_NCS1) || \
