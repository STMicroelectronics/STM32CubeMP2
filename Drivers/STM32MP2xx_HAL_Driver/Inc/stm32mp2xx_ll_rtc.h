...
#ifndef __STM32MP2xx_LL_RTC_H
#define __STM32MP2xx_LL_RTC_H
...
typedef struct
{
  uint32_t TimeFormat; /*!< Specifies the RTC AM/PM Time.
                            ...
                            unitary function @ref LL_RTC_TIME_SetFormat(). */

  uint8_t Hours;       /*!< Specifies the RTC Time Hours.
                            This parameter must be a number between
                            Min_Data = 0 and Max_Data = 12 if the @ref LL_RTC_TIME_FORMAT_PM is selected.
                            This parameter must be a number between
                            Min_Data = 0 and Max_Data = 23 if the @ref LL_RTC_TIME_FORMAT_AM_OR_24 is selected.

                            This feature can be modified afterwards using
                            unitary function @ref LL_RTC_TIME_SetHour(). */

  uint8_t Minutes;     /*!< Specifies the RTC Time Minutes.
                            This parameter must be a number between Min_Data = 0 and Max_Data = 59

                            This feature can be modified afterwards using
                            unitary function @ref LL_RTC_TIME_SetMinute(). */

  uint8_t Seconds;     /*!< Specifies the RTC Time Seconds.
                            This parameter must be a number between Min_Data = 0 and Max_Data = 59

                            This feature can be modified afterwards using
                            unitary function @ref LL_RTC_TIME_SetSecond(). */
} LL_RTC_TimeTypeDef;
...
typedef struct
{
  ...
  uint32_t AlarmMask;            /*!< Specifies the RTC Alarm Masks.
                                      ...
                                      or @ref RTC_LL_EC_ALMB_MASK for ALARM B.

                                      This feature can be modified afterwards using
                                      unitary function @ref LL_RTC_ALMA_SetMask() for ALARM A
  ...
  uint32_t AlarmDateWeekDaySel;  /*!< Specifies the RTC Alarm is on day or WeekDay.
                                      ...
                                      or @ref RTC_LL_EC_ALMB_WEEKDAY_SELECTION for ALARM B
  ...
  uint8_t AlarmDateWeekDay;      /*!< Specifies the RTC Alarm Day/WeekDay.
                                      ...
                                      This feature can be modified afterwards using
                                      unitary function @ref LL_RTC_ALMA_SetDay()
                                      for ALARM A or @ref LL_RTC_ALMB_SetDay() for ALARM B.

                                      If AlarmDateWeekDaySel set to Weekday, this parameter can be
                                      a value of @ref RTC_LL_EC_WEEKDAY.

                                      This feature can be modified afterwards using
                                      unitary function @ref LL_RTC_ALMA_SetWeekDay()
...
/** @defgroup RTC_LL_EC_TAMPER_NOERASE  TAMPER NO ERASE
  * @{
  */
#define LL_RTC_TAMPER_NOERASE_TAMPER1      TAMP_CR2_TAMP1NOER /*!< Tamper 1 event does not erase the backup registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER2      TAMP_CR2_TAMP2NOER /*!< Tamper 2 event does not erase the backup registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER3      TAMP_CR2_TAMP3NOER /*!< Tamper 3 event does not erase the backup registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER4      TAMP_CR2_TAMP4NOER /*!< Tamper 4 event does not erase the backup registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER5      TAMP_CR2_TAMP5NOER /*!< Tamper 5 event does not erase the backup registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER6      TAMP_CR2_TAMP6NOER /*!< Tamper 6 event does not erase the backup registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER7      TAMP_CR2_TAMP7NOER /*!< Tamper 7 event does not erase the backup registers. */
#define LL_RTC_TAMPER_NOERASE_TAMPER8      TAMP_CR2_TAMP8NOER /*!< Tamper 8 event does not erase the backup registers. */
/**
  * @}
  */
...
/** @defgroup RTC_LL_EC_BKP  BACKUP
  * @{
  */
#define LL_RTC_BKP_NUMBER                  RTC_BKP_NB
...
#define LL_RTC_BKP_DR32                    32U
#define LL_RTC_BKP_DR33                    33U
#define LL_RTC_BKP_DR34                    34U
#define LL_RTC_BKP_DR35                    35U
#define LL_RTC_BKP_DR36                    36U
#define LL_RTC_BKP_DR37                    37U
#define LL_RTC_BKP_DR38                    38U
#define LL_RTC_BKP_DR39                    39U
#define LL_RTC_BKP_DR40                    40U
#define LL_RTC_BKP_DR41                    41U
#define LL_RTC_BKP_DR42                    42U
#define LL_RTC_BKP_DR43                    43U
#define LL_RTC_BKP_DR44                    44U
#define LL_RTC_BKP_DR45                    45U
#define LL_RTC_BKP_DR46                    46U
#define LL_RTC_BKP_DR47                    47U
#define LL_RTC_BKP_DR48                    48U
#define LL_RTC_BKP_DR49                    49U
#define LL_RTC_BKP_DR50                    50U
#define LL_RTC_BKP_DR51                    51U
#define LL_RTC_BKP_DR52                    52U
#define LL_RTC_BKP_DR53                    53U
#define LL_RTC_BKP_DR54                    54U
#define LL_RTC_BKP_DR55                    55U
#define LL_RTC_BKP_DR56                    56U
#define LL_RTC_BKP_DR57                    57U
#define LL_RTC_BKP_DR58                    58U
#define LL_RTC_BKP_DR59                    59U
#define LL_RTC_BKP_DR60                    60U
#define LL_RTC_BKP_DR61                    61U
#define LL_RTC_BKP_DR62                    62U
#define LL_RTC_BKP_DR63                    63U
#define LL_RTC_BKP_DR64                    64U
#define LL_RTC_BKP_DR65                    65U
#define LL_RTC_BKP_DR66                    66U
#define LL_RTC_BKP_DR67                    67U
#define LL_RTC_BKP_DR68                    68U
#define LL_RTC_BKP_DR69                    69U
#define LL_RTC_BKP_DR70                    70U
#define LL_RTC_BKP_DR71                    71U
#define LL_RTC_BKP_DR72                    72U
#define LL_RTC_BKP_DR73                    73U
#define LL_RTC_BKP_DR74                    74U
#define LL_RTC_BKP_DR75                    75U
#define LL_RTC_BKP_DR76                    76U
#define LL_RTC_BKP_DR77                    77U
#define LL_RTC_BKP_DR78                    78U
#define LL_RTC_BKP_DR79                    79U
#define LL_RTC_BKP_DR80                    80U
#define LL_RTC_BKP_DR81                    81U
#define LL_RTC_BKP_DR82                    82U
#define LL_RTC_BKP_DR83                    83U
#define LL_RTC_BKP_DR84                    84U
#define LL_RTC_BKP_DR85                    85U
#define LL_RTC_BKP_DR86                    86U
#define LL_RTC_BKP_DR87                    87U
#define LL_RTC_BKP_DR88                    88U
#define LL_RTC_BKP_DR89                    89U
#define LL_RTC_BKP_DR90                    90U
#define LL_RTC_BKP_DR91                    91U
#define LL_RTC_BKP_DR92                    92U
#define LL_RTC_BKP_DR93                    93U
#define LL_RTC_BKP_DR94                    94U
#define LL_RTC_BKP_DR95                    95U
#define LL_RTC_BKP_DR96                    96U
#define LL_RTC_BKP_DR97                    97U
#define LL_RTC_BKP_DR98                    98U
#define LL_RTC_BKP_DR99                    99U
#define LL_RTC_BKP_DR100                   100U
#define LL_RTC_BKP_DR101                   101U
#define LL_RTC_BKP_DR102                   102U
#define LL_RTC_BKP_DR103                   103U
#define LL_RTC_BKP_DR104                   104U
#define LL_RTC_BKP_DR105                   105U
#define LL_RTC_BKP_DR106                   106U
#define LL_RTC_BKP_DR107                   107U
#define LL_RTC_BKP_DR108                   108U
#define LL_RTC_BKP_DR109                   109U
#define LL_RTC_BKP_DR110                   110U
#define LL_RTC_BKP_DR111                   111U
#define LL_RTC_BKP_DR112                   112U
#define LL_RTC_BKP_DR113                   113U
#define LL_RTC_BKP_DR114                   114U
#define LL_RTC_BKP_DR115                   115U
#define LL_RTC_BKP_DR116                   116U
#define LL_RTC_BKP_DR117                   117U
#define LL_RTC_BKP_DR118                   118U
#define LL_RTC_BKP_DR119                   119U
#define LL_RTC_BKP_DR120                   120U
#define LL_RTC_BKP_DR121                   121U
#define LL_RTC_BKP_DR122                   122U
#define LL_RTC_BKP_DR123                   123U
#define LL_RTC_BKP_DR124                   124U
#define LL_RTC_BKP_DR125                   125U
#define LL_RTC_BKP_DR126                   126U
#define LL_RTC_BKP_DR127                   127U
...
#define LL_RTC_SECURE_FULL_NO              RTC_SECCFGR_SEC      /*!< RTC is not full secure, features can be unsecure. See RTC_LL_EC_UNSECURE_RTC_FEATURE */
/**
  * @}
  */
...
#define LL_TAMP_SECURE_FULL_NO             TAMP_SECCFGR_TAMPSEC  /*!< TAMP is not secure */
/**
  * @}
  */
...
/**
  ...
  * @retval Converted byte
  */
#define __LL_RTC_CONVERT_BCD2BIN(__VALUE__) ( ( ( ( ( (uint8_t)(__VALUE__) ) &\
                                                    0xF0U ) >> 0x04U ) * 10U ) + ( ( (uint8_t)(__VALUE__) ) & 0x0FU ) )
...
__STATIC_INLINE uint32_t LL_RTC_DATE_Get(const RTC_TypeDef *RTCx)
{
  ...
  return (uint32_t)(\
                    (((temp & RTC_DR_WDU) >> RTC_DR_WDU_Pos) << RTC_OFFSET_WEEKDAY)                               |
                    (
                                            ...
                                            uint32_t Seconds)
{
  ...
  MODIFY_REG(\
             ...
             (
               ...
               RTC_ALRMAR_MNT | RTC_ALRMAR_MNU | RTC_ALRMAR_ST | RTC_ALRMAR_SU
             ),
             temp
            );
}
...
{
  return (uint32_t)(\
                    (LL_RTC_ALMA_GetHour(RTCx) << RTC_OFFSET_HOUR)       |
                                            ...
                                            uint32_t Seconds)
{
  ...
  MODIFY_REG(\
             RTCx->ALRMBR,
             (
               RTC_ALRMBR_PM  | RTC_ALRMBR_HT  | RTC_ALRMBR_HU |
               RTC_ALRMBR_MNT | RTC_ALRMBR_MNU | RTC_ALRMBR_ST | RTC_ALRMBR_SU
             ),
             temp
            );
}
...
{
  return (uint32_t)(\
                    (LL_RTC_ALMB_GetHour(RTCx) << RTC_OFFSET_HOUR)       |
...
/**
  ...
  * @rmtoll TAMP_CR2       TAMP1NOER     LL_RTC_TAMPER_EnableEraseBKP\n
  *         TAMP_CR2       TAMP2NOER...  LL_RTC_TAMPER_EnableEraseBKP
  * @param  RTCx RTC Instance
  * @param  Tamper This parameter can be a combination of the following values:
...
/**
  ...
  * @rmtoll TAMP_CR2       TAMP1NOER     LL_RTC_TAMPER_DisableEraseBKP\n
  *         TAMP_CR2       TAMP2NOER...  LL_RTC_TAMPER_DisableEraseBKP
  * @param  RTCx RTC Instance
  * @param  Tamper This parameter can be a combination of the following values:
  *         @arg @ref RTC_LL_EC_TAMPER_NOERASE
  *
...
/**
  ...
  * @rmtoll RTC_SECCFGR           INITPROT          LL_RTC_SetRtcSecure
...
{
  MODIFY_REG(RTCx->SECCFGR,
             RTC_SECCFGR_SEC | RTC_SECCFGR_INITSEC | RTC_SECCFGR_CALSEC | RTC_SECCFGR_TSSEC | RTC_SECCFGR_WUTSEC |
             RTC_SECCFGR_ALRASEC | RTC_SECCFGR_ALRBSEC, rtcSecure);
}
...
{
  MODIFY_REG(RTCx->PRIVCR, RTC_PRIVCR_PRIV | RTC_PRIVCR_INITPRIV | RTC_PRIVCR_CALPRIV | RTC_PRIVCR_TSPRIV |
             RTC_PRIVCR_WUTPRIV | RTC_PRIVCR_ALRAPRIV | RTC_PRIVCR_ALRBPRIV, rtcPrivilege);
}
...
{
  return READ_BIT(RTCx->PRIVCR,
                  RTC_PRIVCR_PRIV | RTC_PRIVCR_INITPRIV | RTC_PRIVCR_CALPRIV | RTC_PRIVCR_TSPRIV | RTC_PRIVCR_WUTPRIV |
...
__STATIC_INLINE void LL_RTC_SetBackupRegProtection(const RTC_TypeDef *RTCx, uint32_t startZone2, uint32_t startZone3)
{
  ...
  MODIFY_REG(\
             TAMP->SECCFGR,
             (TAMP_SECCFGR_BKPRWSEC_Msk | TAMP_SECCFGR_BKPWSEC_Msk),
