...
#ifndef STM32MP2xx_HAL_LPTIM_H
#define STM32MP2xx_HAL_LPTIM_H
...
/** @defgroup LPTIM_Exported_Types LPTIM Exported Types
  * @{
  */
#define LPTIM_EXTI_LINE_LPTIM1  EXTI1_IMR2_IM47  /*!< External interrupt line 47 Connected to the LPTIM1 EXTI Line */
#define LPTIM_EXTI_LINE_LPTIM2  EXTI1_IMR2_IM48  /*!< External interrupt line 48 Connected to the LPTIM2 EXTI Line */
#define LPTIM_EXTI_LINE_LPTIM3  EXTI2_IMR1_IM29  /*!< External interrupt line 29 Connected to the LPTIM3 EXTI Line */
#define LPTIM_EXTI_LINE_LPTIM4  EXTI2_IMR1_IM30  /*!< External interrupt line 30 Connected to the LPTIM4 EXTI Line */
#define LPTIM_EXTI_LINE_LPTIM5  EXTI2_IMR1_IM31  /*!< External interrupt line 31 Connected to the LPTIM5 EXTI Line */
...
#define __HAL_LPTIM_LPTIM1_EXTI_ENABLE_IT()            (EXTI1->C1IMR2\
                                                        |= LPTIM_EXTI_LINE_LPTIM1)
#define __HAL_LPTIM_LPTIM1_EXTI_DISABLE_IT()           (EXTI1->C1IMR2\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM1))

#define __HAL_LPTIM_LPTIM2_EXTI_ENABLE_IT()            (EXTI1->C1IMR2\
                                                        |= LPTIM_EXTI_LINE_LPTIM2)
#define __HAL_LPTIM_LPTIM2_EXTI_DISABLE_IT()           (EXTI1->C1IMR2\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM2))

#define __HAL_LPTIM_LPTIM3_EXTI_ENABLE_IT()            (EXTI2->C1IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM3)
#define __HAL_LPTIM_LPTIM3_EXTI_DISABLE_IT()           (EXTI2->C1IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM3))

#define __HAL_LPTIM_LPTIM4_EXTI_ENABLE_IT()            (EXTI2->C1IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM4)
#define __HAL_LPTIM_LPTIM4_EXTI_DISABLE_IT()           (EXTI2->C1IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM4))

#define __HAL_LPTIM_LPTIM5_EXTI_ENABLE_IT()            (EXTI2->C1IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM5)
#define __HAL_LPTIM_LPTIM5_EXTI_DISABLE_IT()           (EXTI2->C1IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM5))
#elif defined(CORE_CM33)
#define __HAL_LPTIM_LPTIM1_EXTI_ENABLE_IT()            (EXTI1->C2IMR2\
                                                        |= LPTIM_EXTI_LINE_LPTIM1)
#define __HAL_LPTIM_LPTIM1_EXTI_DISABLE_IT()           (EXTI1->C2IMR2\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM1))

#define __HAL_LPTIM_LPTIM2_EXTI_ENABLE_IT()            (EXTI1->C2IMR2\
                                                        |= LPTIM_EXTI_LINE_LPTIM2)
#define __HAL_LPTIM_LPTIM2_EXTI_DISABLE_IT()           (EXTI1->C2IMR2\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM2))

#define __HAL_LPTIM_LPTIM3_EXTI_ENABLE_IT()            (EXTI2->C2IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM3)
#define __HAL_LPTIM_LPTIM3_EXTI_DISABLE_IT()           (EXTI2->C2IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM3))

#define __HAL_LPTIM_LPTIM4_EXTI_ENABLE_IT()            (EXTI2->C2IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM4)
#define __HAL_LPTIM_LPTIM4_EXTI_DISABLE_IT()           (EXTI2->C2IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM4))

#define __HAL_LPTIM_LPTIM5_EXTI_ENABLE_IT()            (EXTI2->C2IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM5)
#define __HAL_LPTIM_LPTIM5_EXTI_DISABLE_IT()           (EXTI2->C2IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM5))
#elif defined(CORE_CM0PLUS)

#define __HAL_LPTIM_LPTIM3_EXTI_ENABLE_IT()            (EXTI2->C3IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM3)
#define __HAL_LPTIM_LPTIM3_EXTI_DISABLE_IT()           (EXTI2->C3IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM3))

#define __HAL_LPTIM_LPTIM4_EXTI_ENABLE_IT()            (EXTI2->C3IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM4)
#define __HAL_LPTIM_LPTIM4_EXTI_DISABLE_IT()           (EXTI2->C3IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM4))

#define __HAL_LPTIM_LPTIM5_EXTI_ENABLE_IT()            (EXTI2->C3IMR1\
                                                        |= LPTIM_EXTI_LINE_LPTIM5)
#define __HAL_LPTIM_LPTIM5_EXTI_DISABLE_IT()           (EXTI2->C3IMR1\
                                                        &= ~(LPTIM_EXTI_LINE_LPTIM5))
#endif /* CORE */
...
#if defined (CORE_CM33) && defined (CORTEX_IN_SECURE_STATE)
#define IS_LPTIM_CCX_INSTANCE(__INSTANCE__, __CHANNEL__) \
  (((((__INSTANCE__) == LPTIM1_NS)  || ((__INSTANCE__) == LPTIM1_S))  && \
   ...
   ((((__INSTANCE__) == LPTIM5_NS)  || ((__INSTANCE__) == LPTIM5_S))  && \
    ((__CHANNEL__)  == LPTIM_CHANNEL_1)))
#elif (defined (CORE_CM33) && ! defined (CORTEX_IN_SECURE_STATE)) || defined (CORE_CA35)
#define IS_LPTIM_CCX_INSTANCE(__INSTANCE__, __CHANNEL__) \
  ((((__INSTANCE__)  == LPTIM1)  && \
    (((__CHANNEL__)  == LPTIM_CHANNEL_1) ||  \
     ((__CHANNEL__)  == LPTIM_CHANNEL_2)))   \
