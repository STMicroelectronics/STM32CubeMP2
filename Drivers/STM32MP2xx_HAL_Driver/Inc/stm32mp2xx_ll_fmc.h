...
#ifndef STM32MP2xx_LL_FMC_H
#define STM32MP2xx_LL_FMC_H
...
/** @addtogroup FMC_LL_Private_Macros
  * @{
  */
#define IS_FMC_ITEM_CID(__ITEM__) (((__ITEM__) >= FMC_COMMON) && \
                                   ((__ITEM__) <= FMC_NAND))
#define IS_FMC_ATTRIBUTES_CID(__ATTRIBUTE__) ((((__ATTRIBUTE__) & \
                                                FMC_CID_DYNAMIC_SELECT) == FMC_CID_DYNAMIC_SELECT) || \
                                              (((__ATTRIBUTE__) & \
                                                FMC_CID_STATIC_SELECT) == FMC_CID_STATIC_SELECT) || \
                                              (((__ATTRIBUTE__) & FMC_CID_DISABLE) == FMC_CID_DISABLE) || \
                                              (((__ATTRIBUTE__) & FMC_SEC_SELECT) == FMC_SEC_SELECT) || \
                                              (((__ATTRIBUTE__) & FMC_PRIV_SELECT) == FMC_PRIV_SELECT))
...
#define IS_FMC_NAND_BANK(__BANK__) (((__BANK__) == FMC_NAND_BANK1) || \
                                    ((__BANK__) == FMC_NAND_BANK2) || \
                                    ((__BANK__) == FMC_NAND_BANK3) || \
                                    ((__BANK__) == FMC_NAND_BANK4))
...
typedef struct
{
  ...
  uint32_t DataLatency;                  /*!< Defines the number of memory clock cycles to issue
                                          ...
                                          - It may assume a value between Min_Data = 2 and Max_Data = 17 in
                                            NOR Flash memories with synchronous burst mode enable                    */
...
/** @addtogroup FMC_LL_Exported_Constants FMC Low Layer Exported Constants
  * @{
  */
/** @defgroup COMMON NOR/PSRAM and NAND
  * @{
  */
#define FMC_COMMON        0U
#define FMC_NOR_PSRAM_1   1U
#define FMC_NOR_PSRAM_2   2U
#define FMC_NOR_PSRAM_3   3U
#define FMC_NOR_PSRAM_4   4U
#define FMC_NAND          5U
...
/** @defgroup FMC_Attributes FMC Attributes
  * @brief FMC CID, secure or non-secure and privileged or non-privileged attributes
  * @note attributes write/read access depends on CID filtering and secure configuration activation
  * @{
  */
#define FMC_CID_DISABLE              0x80000000U

#define FMC_PRIV                     (FMC_PRIV_SELECT | (1U << FMC_PRIV_VAL_Pos))
#define FMC_NPRIV                    (FMC_PRIV_SELECT)

#define FMC_SEC                      (FMC_SEC_SELECT | (1U << FMC_SEC_VAL_Pos))
#define FMC_NSEC                     (FMC_SEC_SELECT)

#define FMC_CID_DYNAMIC_0            (FMC_CID_DYNAMIC_SELECT | FMC_CIDCFGR0_SEMWLC0)         /*!< Enable CID filtering (shared mode) and give control to CID0 */
#define FMC_CID_DYNAMIC_1            (FMC_CID_DYNAMIC_SELECT | FMC_CIDCFGR0_SEMWLC1)         /*!< Enable CID filtering (shared mode) and give control to CID1 */
#define FMC_CID_DYNAMIC_2            (FMC_CID_DYNAMIC_SELECT | FMC_CIDCFGR0_SEMWLC2)         /*!< Enable CID filtering (shared mode) and give control to CID2 */
#define FMC_CID_DYNAMIC_3            (FMC_CID_DYNAMIC_SELECT | FMC_CIDCFGR0_SEMWLC3)         /*!< Enable CID filtering (shared mode) and give control to CID3 */

#define FMC_CID_STATIC_0             (FMC_CID_STATIC_SELECT | (0 << FMC_CIDCFGR0_SCID_Pos))  /*!< Enable CID filtering (static mode) and give control to CID0 */
#define FMC_CID_STATIC_1             (FMC_CID_STATIC_SELECT | (1 << FMC_CIDCFGR0_SCID_Pos))  /*!< Enable CID filtering (static mode) and give control to CID1 */
#define FMC_CID_STATIC_2             (FMC_CID_STATIC_SELECT | (2 << FMC_CIDCFGR0_SCID_Pos))  /*!< Enable CID filtering (static mode) and give control to CID2 */
#define FMC_CID_STATIC_3             (FMC_CID_STATIC_SELECT | (3 << FMC_CIDCFGR0_SCID_Pos))  /*!< Enable CID filtering (static mode) and give control to CID3 */
...
/** @defgroup FMC_NAND_Bank FMC NAND Bank
  * @{
  */
#define FMC_NAND_BANK1                          ((uint32_t)0x00000000)
#define FMC_NAND_BANK2                          ((uint32_t)0x00000400)
#define FMC_NAND_BANK3                          ((uint32_t)0x00000800)
#define FMC_NAND_BANK4                          ((uint32_t)0x00000C00)
/**
  * @}
  */
...
/** @defgroup FMC_LL_Interrupt_definition FMC Low Layer Interrupt definition
  * @{
  */
#define FMC_IT_RISING_EDGE                      ((uint32_t)0x00000001)
#define FMC_IT_LEVEL                            ((uint32_t)0x00000002)
#define FMC_IT_FALLING_EDGE                     ((uint32_t)0x00000004)
/**
  * @}
  */
...
/**
  ...
  */
/* Private constants -------------------------------------------------------------*/
/** @defgroup FMC_LL_Private_Constants FMC_LL  Private Constants
  * @{
  */
#define FMC_CID_DYNAMIC_MASK        (FMC_CIDCFGR0_SEMWLC3 |\
                                     FMC_CIDCFGR0_SEMWLC2 | FMC_CIDCFGR0_SEMWLC1 | FMC_CIDCFGR0_SEMWLC0)
#define FMC_CID_DYNAMIC_SELECT      0x10000000U
#define FMC_CID_STATIC_SELECT       0x20000000U
#define FMC_PRIV_SELECT             0x01000000U
#define FMC_SEC_SELECT              0x02000000U

#define FMC_PRIV_VAL_Pos            0
#define FMC_SEC_VAL_Pos             1
...
/**
  ...
  * @retval None
  */
#define __FMC_ENABLE()  (FMC_COMMON_DEVICE->CFGR |= FMC_CFGR_FMCEN)

/**
  * @brief  Disable the FMC Peripheral.
  * @retval None
  */
#define __FMC_DISABLE()  (FMC_COMMON_DEVICE->CFGR &= ~FMC_CFGR_FMCEN)
...
/**
  ...
  * @retval None
  */
#define __FMC_NAND_ENABLE_IT(__INSTANCE__, __INTERRUPT__)  ((__INSTANCE__)->IER |= (__INTERRUPT__))
...
/**
  ...
  * @retval None
  */
#define __FMC_NAND_DISABLE_IT(__INSTANCE__, __INTERRUPT__)  ((__INSTANCE__)->IER &= ~(__INTERRUPT__))
...
/**
  ...
  */
#define __FMC_NAND_GET_FLAG(__INSTANCE__, __BANK__, __FLAG__)  (((__INSTANCE__)->ISR &(__FLAG__)) == (__FLAG__))
...
/**
  ...
  * @retval None
  */
#define __FMC_NAND_CLEAR_FLAG(__INSTANCE__, __FLAG__)  ((__INSTANCE__)->ICR |= (__FLAG__))
...
/**
  ...
  */
/* Exported functions --------------------------------------------------------*/
/**@defgroup FMC_LL_Exported_Functions FMC LL Exported Functions
  *  @{
  */
/** @addtogroup RIF protection configuration functions
  * @{
  */
...
HAL_StatusTypeDef  FMC_NORSRAM_Timing_Init(FMC_NORSRAM_TypeDef *Device, FMC_NORSRAM_TimingTypeDef *Timing,
                                           uint32_t Bank);
HAL_StatusTypeDef  FMC_NORSRAM_Extended_Timing_Init(FMC_NORSRAM_EXTENDED_TypeDef *Device,
                                                    FMC_NORSRAM_TimingTypeDef *Timing,
                                                    uint32_t Bank,
                                                    uint32_t ExtendedMode);
HAL_StatusTypeDef  FMC_NORSRAM_DeInit(FMC_NORSRAM_TypeDef *Device, FMC_NORSRAM_EXTENDED_TypeDef *ExDevice,
                                      uint32_t Bank);
/**
  * @}
  */
