...
ErrorStatus LL_GPIO_DeInit(const GPIO_TypeDef *GPIOx)
{
  ...
  if (GPIOx == GPIOA)
  {
    LL_RCC_GPIOA_ForceReset();
    LL_RCC_GPIOA_ReleaseReset();
  }
  else if (GPIOx == GPIOB)
  {
    LL_RCC_GPIOB_ForceReset();
    LL_RCC_GPIOB_ReleaseReset();
  }
  else if (GPIOx == GPIOC)
  {
    LL_RCC_GPIOC_ForceReset();
    LL_RCC_GPIOC_ReleaseReset();
  }
  else if (GPIOx == GPIOD)
  {
    LL_RCC_GPIOD_ForceReset();
    LL_RCC_GPIOD_ReleaseReset();
  }
  else if (GPIOx == GPIOE)
  {
    LL_RCC_GPIOE_ForceReset();
    LL_RCC_GPIOE_ReleaseReset();
  }
  else if (GPIOx == GPIOF)
  {
    LL_RCC_GPIOF_ForceReset();
    LL_RCC_GPIOF_ReleaseReset();
  }
  else if (GPIOx == GPIOG)
  {
    LL_RCC_GPIOG_ForceReset();
    LL_RCC_GPIOG_ReleaseReset();
  }
  else if (GPIOx == GPIOH)
  {
    LL_RCC_GPIOH_ForceReset();
    LL_RCC_GPIOH_ReleaseReset();
  }
  else if (GPIOx == GPIOI)
  {
