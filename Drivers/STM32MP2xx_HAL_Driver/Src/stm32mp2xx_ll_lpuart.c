...
/*              Baudrate specified by the user should belong to [8, 66666667].*/
#define IS_LL_LPUART_BAUDRATE(__BAUDRATE__) (((__BAUDRATE__) <= 66666667U) && ((__BAUDRATE__) >= 8U))
