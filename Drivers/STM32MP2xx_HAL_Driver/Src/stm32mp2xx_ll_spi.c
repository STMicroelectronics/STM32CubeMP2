...
ErrorStatus LL_SPI_DeInit(const SPI_TypeDef *SPIx)
{
  ...
  if (SPIx == SPI1)
  {
    ...
    LL_RCC_SPI1_ForceReset();

    /* Release reset of SPI clock */
    LL_RCC_SPI1_ReleaseReset();
  ...
  {
    /* Force reset of SPI clock */
    LL_RCC_SPI2_ForceReset();

    /* Release reset of SPI clock */
    LL_RCC_SPI2_ReleaseReset();
  ...
  {
    /* Force reset of SPI clock */
    LL_RCC_SPI3_ForceReset();

    /* Release reset of SPI clock */
    LL_RCC_SPI3_ReleaseReset();
  ...
  {
    /* Force reset of SPI clock */
    LL_RCC_SPI4_ForceReset();

    /* Release reset of SPI clock */
    LL_RCC_SPI4_ReleaseReset();
  ...
  {
    /* Force reset of SPI clock */
    LL_RCC_SPI5_ForceReset();

    /* Release reset of SPI clock */
    LL_RCC_SPI5_ReleaseReset();
  ...
  {
    /* Force reset of SPI clock */
    LL_RCC_SPI6_ForceReset();

    /* Release reset of SPI clock */
    LL_RCC_SPI6_ReleaseReset();
  ...
  {
    /* Force reset of SPI clock */
    LL_RCC_SPI7_ForceReset();

    /* Release reset of SPI clock */
    LL_RCC_SPI7_ReleaseReset();

    /* Update the return status */
    status = SUCCESS;
  }
#endif /* SPI7 */
#if defined(SPI8) && ! defined(CORE_CM0PLUS)
  if (SPIx == SPI8)
  {
    /* Force reset of SPI clock */
    LL_RCC_SPI8_ForceReset();

    /* Release reset of SPI clock */
    LL_RCC_SPI8_ReleaseReset();

    /* Update the return status */
    status = SUCCESS;
  }
#endif /* SPI8 && ! CORE_CM0PLUS */
  return status;
}
