...
ErrorStatus LL_RTC_DeInit(RTC_TypeDef *RTCx)
{
  ...
  LL_RTC_WriteReg(TAMP, CR1,      0x00000000U);
  LL_RTC_WriteReg(TAMP, CR2,     0x00000000U);
#if defined (RTC_OTHER_SUPPORT)
  LL_RTC_WriteReg(TAMP, CR3,     0x00000000U);
  LL_RTC_WriteReg(TAMP, SECCFGR,     0x00000000U);
  LL_RTC_WriteReg(TAMP, PRIVCR,   0x00000000U);
#endif /* RTC_OTHER_SUPPORT */
  LL_RTC_WriteReg(TAMP, FLTCR,    0x00000000U);
#if defined (RTC_ACTIVE_TAMPER_SUPPORT)
  LL_RTC_WriteReg(TAMP, ATCR1,    0x00070000U);
  LL_RTC_WriteReg(TAMP, ATCR2,    0x00000000U);
#endif /* RTC_ACTIVE_TAMPER_SUPPORT */
  LL_RTC_WriteReg(TAMP, IER,      0x00000000U);
  LL_RTC_WriteReg(TAMP, SCR,      0x00000000U);
#if defined (RTC_OPTION_REG_SUPPORT)
  /* LL_RTC_WriteReg(TAMP, OR,       0x00000000U); */
