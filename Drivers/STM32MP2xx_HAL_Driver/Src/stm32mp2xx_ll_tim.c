...
ErrorStatus LL_TIM_DeInit(const TIM_TypeDef *TIMx)
{
  ...
  if (TIMx == TIM1)
  {
    LL_RCC_TIM1_ForceReset();
    LL_RCC_TIM1_ReleaseReset();
  }
  else if (TIMx == TIM2)
  {
    LL_RCC_TIM2_ForceReset();
    LL_RCC_TIM2_ReleaseReset();
  }
  else if (TIMx == TIM3)
  {
    LL_RCC_TIM3_ForceReset();
    LL_RCC_TIM3_ReleaseReset();
  }
  else if (TIMx == TIM4)
  {
    LL_RCC_TIM4_ForceReset();
    LL_RCC_TIM4_ReleaseReset();
  }
  else if (TIMx == TIM5)
  {
    LL_RCC_TIM5_ForceReset();
    LL_RCC_TIM5_ReleaseReset();
  }
  else if (TIMx == TIM6)
  {
    LL_RCC_TIM6_ForceReset();
    LL_RCC_TIM6_ReleaseReset();
  }
  else if (TIMx == TIM7)
  {
    LL_RCC_TIM7_ForceReset();
    LL_RCC_TIM7_ReleaseReset();
  }
  else if (TIMx == TIM8)
  {
    LL_RCC_TIM8_ForceReset();
    LL_RCC_TIM8_ReleaseReset();
  }
  else if (TIMx == TIM10)
  {
    LL_RCC_TIM10_ForceReset();
    LL_RCC_TIM10_ReleaseReset();
  }
  else if (TIMx == TIM11)
  {
    LL_RCC_TIM11_ForceReset();
    LL_RCC_TIM11_ReleaseReset();
  }
  else if (TIMx == TIM12)
  {
    LL_RCC_TIM12_ForceReset();
    LL_RCC_TIM12_ReleaseReset();
  }
  else if (TIMx == TIM13)
  {
    LL_RCC_TIM13_ForceReset();
    LL_RCC_TIM13_ReleaseReset();
  }
  else if (TIMx == TIM14)
  {
    LL_RCC_TIM14_ForceReset();
    LL_RCC_TIM14_ReleaseReset();
  }
  else if (TIMx == TIM15)
  {
    LL_RCC_TIM15_ForceReset();
    LL_RCC_TIM15_ReleaseReset();
  }
  else if (TIMx == TIM16)
  {
    LL_RCC_TIM16_ForceReset();
    LL_RCC_TIM16_ReleaseReset();
  }
  else if (TIMx == TIM17)
  {
