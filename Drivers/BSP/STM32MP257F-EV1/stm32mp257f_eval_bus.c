/**
  ******************************************************************************
  * @file    stm32mp257f_eval_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32MP257XX-VALIDX board (MB170/4,5,6)
...
/* #define I2C_TIMINGR                     I2C_HSI_TIMING_400KHZ */
...
int32_t BSP_I2C1_Init(void)
{
  ...
  if (I2c1InitCounter == 0U)
  {
    ...
    if (HAL_I2C_GetState(&hbus_i2c1) == HAL_I2C_STATE_RESET)
    {
      ...
      {
#endif /* USE_HAL_I2C_REGISTER_CALLBACKS */
      if (MX_I2C1_Init(&hbus_i2c1, I2C_GetTiming(HAL_RCC_GetFreq(RCC_CLOCKTYPE_ICN_HS_MCU), \
                                                 BUS_I2C1_FREQUENCY)) != HAL_OK)
        /*      if (MX_I2C1_Init(&hbus_i2c1, I2C_TIMINGR) != HAL_OK) */
      {
...
int32_t BSP_I2C2_Init(void)
{
  ...
  if (I2c2InitCounter == 0U)
  {
    ...
    if (HAL_I2C_GetState(&hbus_i2c2) == HAL_I2C_STATE_RESET)
    {
      ...
      {
#endif /* BSP_USE_CMSIS_OS */
      if (MX_I2C2_Init(&hbus_i2c2, I2C_GetTiming(HAL_RCC_GetFreq(RCC_CLOCKTYPE_ICN_HS_MCU), \
...
int32_t BSP_I2C7_Init(void)
{
  ...
  if (I2c7InitCounter == 0U)
  {
    ...
    if (HAL_I2C_GetState(&hbus_i2c7) == HAL_I2C_STATE_RESET)
    {
      ...
      {
#endif /* USE_HAL_I2C_REGISTER_CALLBACKS */
      if (MX_I2C7_Init(&hbus_i2c7, I2C_GetTiming(HAL_RCC_GetFreq(RCC_CLOCKTYPE_ICN_HS_MCU), \
                                                 BUS_I2C7_FREQUENCY)) != HAL_OK)
        /*      if (MX_I2C7_Init(&hbus_i2c7, I2C_TIMINGR) != HAL_OK) */
      {
        ret = BSP_ERROR_BUS_FAILURE;
      }
#if (USE_HAL_I2C_REGISTER_CALLBACKS > 0)
