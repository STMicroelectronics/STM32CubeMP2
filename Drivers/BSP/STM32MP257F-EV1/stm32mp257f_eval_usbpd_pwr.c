...
/** @defgroup USBPD_PWR_Exported_Variables Exported Variables
  * @{
  */
/**
  * @}
...
/** @defgroup USBPD_PWR_Private_Typedef Private Typedef
  * @{
  */
/**
...
/** @defgroup USBPD_PWR_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup USBPD_PWR_Private_Macros Private Macros
  * @{
  */
#ifdef _TRACE
...
/** @defgroup USBPD_PWR_Private_Functions Private Functions
  * @{
  */
...
/** @defgroup USBPD_PWR_Private_Variables Private Variables
  * @{
  */
...
/** @addtogroup USBPD_PWR_Exported_Functions
  * @{
  */
...
int32_t BSP_USBPD_PWR_VBUSGetVoltage(uint32_t PortNum, uint32_t *pVoltage)
{
  ...
  else
  {
    ...
    voltage = PWR_TCPP0203_ConvertADCDataToVoltage(adc_value, STM32MP257F_EVAL_VSENSE_RA, STM32MP257F_EVAL_VSENSE_RB);
    *pVoltage = voltage;
  }
  return ret;
}
...
/** @addtogroup USBPD_PWR_Private_Functions
  * @{
  */
...
static void PWR_TCPP0203_GPIOConfigInit(uint32_t PortNum)
{
  ...
  if (ResMgr_Request(TCPP0203_PORT0_EN_RIF_RES_TYP_GPIO,
                     TCPP0203_PORT0_EN_GPIO_RIF_RES_NUM_GPIO) != RESMGR_STATUS_ACCESS_OK)
  {
    while (1) {};
  }
  ...
  if (ResMgr_Request(TCPP0203_PORT0_VBUSCGPIO_RIF_RES_TYP_GPIO,
                     TCPP0203_PORT0_VBUSC_GPIO_RIF_RES_NUM_GPIO) != RESMGR_STATUS_ACCESS_OK)
  {
    while (1) {};
  }
...
static void PWR_TCPP0203_ITConfigInit(uint32_t PortNum)
{
  if (USBPD_PWR_Port_Status[PortNum].IsItEnabled == 0U)
  {
    ...
    if (ResMgr_Request(TCPP0203_PORT0_FLG_RIF_RES_TYP_GPIO,
                       TCPP0203_PORT0_FLG_GPIO_RIF_RES_NUM_GPIO) != RESMGR_STATUS_ACCESS_OK)
    {
      while (1) {};
    }
...
/**
  * @brief  Deinit TCPP0203 low level interrupt.
  * @note   Corresponds to EXTI unmap of FLGn pin of TCPP0203
  * @param  PortNum   Port number
  * @retval None
  */
static void PWR_TCPP0203_ITConfigDeInit(uint32_t PortNum)
...
static int32_t PWR_TCPP0203_BUSConfigInit(uint32_t PortNum, uint16_t Address)
{
  ...
  TCPP0203IOCtx.Init        = BSP_I2C1_Init;
  TCPP0203IOCtx.DeInit      = BSP_I2C1_DeInit;
  TCPP0203IOCtx.ReadReg     = BSP_I2C1_ReadReg;
  TCPP0203IOCtx.WriteReg    = BSP_I2C1_WriteReg;
