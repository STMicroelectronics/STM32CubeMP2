/**
  ******************************************************************************
  * @file    stm32mp215f_disco_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32MP215XX-DK board
...
/** @defgroup STM32MP215F_DK_BUS BUS
  * @{
  */

/** @defgroup STM32MP215F_DK_BUS_Private_Constants BUS Private Constants
  * @{
  */
...
/** @defgroup STM32MP215F_DK_BUS_Private_Types BUS Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32MP215F_DK_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32MP215F_DK_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32MP215F_DK_BUS_Private_FunctionPrototypes BUS Private FunctionPrototypes
  * @{
  */
#if defined (CORE_CA35) || defined (CORE_CM33)
...
/** @defgroup STM32MP215F_DK_BUS_Exported_Functions BUS Exported Functions
  * @{
  */
#if defined (CORE_CA35) || defined (CORE_CM33)
...
int32_t BSP_I2C1_Init(void)
{
  ...
  if (I2c1InitCounter == 0U)
  {
    ...
    if (RESMGR_STATUS_ACCESS_OK != ResMgr_Request(RESMGR_RESOURCE_RIFSC, RESMGR_RIFSC_I2C1_ID))
    {
...
int32_t BSP_I2C1_DeInit(void)
{
  ...
  (void)ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOA, RESMGR_GPIO_PIN(2));
  (void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, RESMGR_RIFSC_I2C1_ID);
...
int32_t BSP_I2C2_Init(void)
{
  ...
  if (I2c2InitCounter == 0U)
  {
    ...
    if (RESMGR_STATUS_ACCESS_OK != ResMgr_Request(RESMGR_RESOURCE_RIFSC, RESMGR_RIFSC_I2C2_ID))
    {
      ret = BSP_ERROR_BUS_FAILURE;
    }
...
int32_t BSP_I2C2_DeInit(void)
{
  ...
  (void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, RESMGR_RIFSC_I2C2_ID);
...
int32_t BSP_I2C3_Init(void)
{
  ...
  if (I2c3InitCounter == 0U)
  {
    ...
    if (ResMgr_Request(RESMGR_RESOURCE_RIF_RCC, RESMGR_RCC_RESOURCE(101)) == RESMGR_STATUS_ACCESS_OK)
    {
      /* Enable SCL GPIO clock */
    ...
    /* Acquire I2C3 using Resource manager */
    if (RESMGR_STATUS_ACCESS_OK != ResMgr_Request(RESMGR_RESOURCE_RIFSC, RESMGR_RIFSC_I2C3_ID))
    {
      ret = BSP_ERROR_BUS_FAILURE;
    }
/* TODO: To be enabled after res_mgr changes are done for MP21 */
    ...
    /* Acquire GPIOZ0 using Resource manager */
    if (RESMGR_STATUS_ACCESS_OK != ResMgr_Request(RESMGR_RESOURCE_RIF_GPIOZ, RESMGR_GPIO_PIN(0)))
    {
      ret = BSP_ERROR_BUS_FAILURE;
    }
#endif /*0*/
    if (HAL_I2C_GetState(&hbus_i2c3) == HAL_I2C_STATE_RESET)
    {
      ...
      {
#endif /* USE_HAL_I2C_REGISTER_CALLBACKS */
      if (MX_I2C3_Init(&hbus_i2c3,
                       I2C_GetTiming(HAL_RCC_GetFreq(RCC_CLOCKTYPE_ICN_HS_MCU), BUS_I2C3_FREQUENCY)) != HAL_OK)
      {
        ret = BSP_ERROR_BUS_FAILURE;
      }
#if (USE_HAL_I2C_REGISTER_CALLBACKS > 0)
...
int32_t BSP_I2C3_DeInit(void)
{
  ...
  /* Release the resources */
  (void)ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOZ, RESMGR_GPIO_PIN(1));
  (void)ResMgr_Release(RESMGR_RESOURCE_RIF_GPIOZ, RESMGR_GPIO_PIN(0));
  (void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, RESMGR_RIFSC_I2C3_ID);
...
/** @defgroup STM32MP215F_DK_BUS_Private_Functions BUS Private Functions
  * @{
  */
/**
...
static int32_t I2C3_Recv(uint16_t DevAddr, uint8_t *pData, uint16_t Length)
{
  if (HAL_I2C_Master_Receive(&hbus_i2c3, DevAddr, pData, Length, 10000) == HAL_OK)
  {
    return BSP_ERROR_NONE;
  }
...
static int32_t I2C3_Send(uint16_t DevAddr, uint8_t *pData, uint16_t Length)
{
  if (HAL_I2C_Master_Transmit(&hbus_i2c3, DevAddr, pData, Length, 10000) == HAL_OK)
  {
    return BSP_ERROR_NONE;
  }
