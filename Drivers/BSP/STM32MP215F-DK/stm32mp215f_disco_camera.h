/**
  ******************************************************************************
  * @file    stm32mp215f_disco_camera.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32mp257f_disco_camera.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32MP257F_DK_CAMERA_H
#define STM32MP257F_DK_CAMERA_H
...
/** @defgroup Constants Exported Constants
  * @{
  */
...
#define CAMERA_STBYN_PIN                GPIO_PIN_0
#define CAMERA_STBYN_GPIO_PORT          GPIOD
#define CAMERA_STBYN_GPIO_CLK_ENABLE()  __HAL_RCC_GPIOD_CLK_ENABLE()

#define CAMERA_RST_PIN                  GPIO_PIN_5
#define CAMERA_RST_GPIO_PORT            GPIOD
#define CAMERA_RST_GPIO_CLK_ENABLE()    __HAL_RCC_GPIOD_CLK_ENABLE()
