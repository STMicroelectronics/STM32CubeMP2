/**
  ******************************************************************************
  * @file    stm32mp215f_disco.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage
  *          LEDs
  *          push-buttons
  *          COM ports
  *          available on STM32MP215F_DK board (MB2059) from STMicroelectronics.
  ******************************************************************************
  * @attention
  *
...
USART_TypeDef *COM_USART[COMn] = { COM_CA35_UART, COM_CM33_UART };
#endif /* (USE_BSP_COM_FEATURE > 0) */
/**
  * @}
  */
...
static const GPIO_PinState GPIO_LED_OFF[LEDn] = {
                                                  GPIO_PIN_SET,
                                                  GPIO_PIN_RESET,
                                                  GPIO_PIN_RESET,
                                                  GPIO_PIN_RESET
...
static const GPIO_PinState GPIO_LED_ON[LEDn] = {
                                                  GPIO_PIN_RESET,
                                                  GPIO_PIN_SET,
                                                  GPIO_PIN_SET,
                                                  GPIO_PIN_SET
...
static const ResMgr_Res_Type_t LED_RIF_RES_TYPn[LEDn] = {
                                                        LED1_GPIO_RIF_RES_TYP_GPIO,
                                                        LED2_GPIO_RIF_RES_TYP_GPIO,
                                                        LED3_GPIO_RIF_RES_TYP_GPIO,
                                                        LED4_GPIO_RIF_RES_TYP_GPIO
                                                      };

static const uint8_t LED_RIF_RES_NUMn[LEDn] = {
                                                LED1_GPIO_RIF_RES_NUM_GPIO,
                                                LED2_GPIO_RIF_RES_NUM_GPIO,
                                                LED3_GPIO_RIF_RES_NUM_GPIO,
                                                LED4_GPIO_RIF_RES_NUM_GPIO
                                              };
...
static const ResMgr_Res_Type_t BUTTON_RIF_RES_TYPn[BUTTONn] = {
                                                        BUTTON_WAKEUP_RIF_RES_TYP_GPIO,
                                                        BUTTON_USER1_RIF_RES_TYP_GPIO,
                                                        BUTTON_USER2_RIF_RES_TYP_GPIO,
                                                        BUTTON_TAMPER_RIF_RES_TYP_GPIO
                                                      };

static const uint8_t BUTTON_RIF_RES_NUMn[BUTTONn] = {
                                                        BUTTON_WAKEUP_RIF_RES_NUM_GPIO,
                                                        BUTTON_USER1_RIF_RES_NUM_GPIO,
                                                        BUTTON_USER2_RIF_RES_NUM_GPIO,
                                                        BUTTON_TAMPER_RIF_RES_NUM_GPIO
                                                      };
...
/**
  * @brief  This method returns the STM32MP215FXX DK BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
int32_t BSP_GetVersion(void)
{
  return (int32_t)STM32MP215F_DK_BSP_VERSION;
}
...
{
  return (uint8_t *)STM32MP215F_DK_BSP_BOARD_NAME;
}
...
{
  return (uint8_t *)STM32MP215F_DK_BSP_BOARD_ID;
}
...
static int32_t BSP_LED_MspInit(Led_TypeDef Led)
{
  ...
  {
    if (ResMgr_Request(LED_RIF_RES_TYPn[Led], LED_RIF_RES_NUMn[Led]) != RESMGR_STATUS_ACCESS_OK)
    {
...
static int32_t BSP_LED_MspDeInit(Led_TypeDef Led)
{
  ...
  if (!IS_DEVELOPER_BOOT_MODE())
  {
    (void)ResMgr_Release(LED_RIF_RES_TYPn[Led], LED_RIF_RES_NUMn[Led]);
  }
  return ret;
}
...
static int32_t BSP_PB_MspInit(Button_TypeDef Button)
{
  ...
  if (!IS_DEVELOPER_BOOT_MODE())
  {
    if (ResMgr_Request(BUTTON_RIF_RES_TYPn[Button], BUTTON_RIF_RES_NUMn[Button]) != RESMGR_STATUS_ACCESS_OK)
    {
      ret = BSP_ERROR_MSP_FAILURE;
    }
  }
...
static int32_t BSP_PB_MspDeInit(Button_TypeDef Button)
{
  ...
  if (!IS_DEVELOPER_BOOT_MODE())
  {
    (void)ResMgr_Release(BUTTON_RIF_RES_TYPn[Button], BUTTON_RIF_RES_NUMn[Button]);
  }
  return ret;
}
...
int32_t BSP_COM_Init(COM_TypeDef COM, COM_InitTypeDef *COM_Init)
{
  ...
  else
  {
    ...
    if ((!IS_DEVELOPER_BOOT_MODE()))
    {
      ...
      else if (COM == COM_VCP_CA35)
      {
        if ((ResMgr_Request(COM_CA35_RIF_RES_TYP_TX_PIN, COM_CA35_RIF_RES_NUM_TX_PIN) != RESMGR_STATUS_ACCESS_OK)
            && (ResMgr_Request(COM_CA35_RIF_RES_TYP_RX_PIN, COM_CA35_RIF_RES_NUM_RX_PIN) != RESMGR_STATUS_ACCESS_OK)
            && (ResMgr_Request(COM_CA35_RIF_RES_TYP_UART, COM_CA35_RIF_RES_NUM_UART) != RESMGR_STATUS_ACCESS_OK))
        {
          return BSP_ERROR_MSP_FAILURE;
        }
      }
...
/** @defgroup STM32MP215F_DK_LOW_LEVEL_Private_Functions Private Functions
  * @{
  */
...
static void USART_MspInit(UART_HandleTypeDef *huart)
{
  ...
  if (huart->Instance == COM_CA35_UART)
  {
    ...
    if (!COM_CA35_TX_GPIO_IS_CLK_ENABLED())
    {
      if (RESMGR_STATUS_ACCESS_OK == ResMgr_Request(RESMGR_RESOURCE_RIF_RCC, RESMGR_RCC_RESOURCE(90)))
      {
    ...
    if (!COM_CA35_RX_GPIO_IS_CLK_ENABLED())
    {
      if (RESMGR_STATUS_ACCESS_OK == ResMgr_Request(RESMGR_RESOURCE_RIF_RCC, RESMGR_RCC_RESOURCE(90)))
      {
...
static void USART_MspDeInit(UART_HandleTypeDef *huart)
{
  ...
  if (huart->Instance == COM_CA35_UART)
  {
    ...
    (void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, COM_CA35_RIF_RES_NUM_UART);
    (void)ResMgr_Release(COM_CA35_RIF_RES_TYP_TX_PIN, COM_CA35_RIF_RES_NUM_TX_PIN);
    (void)ResMgr_Release(COM_CA35_RIF_RES_TYP_RX_PIN, COM_CA35_RIF_RES_NUM_RX_PIN);
  }
  else if (huart->Instance == COM_CM33_UART)
  {
    /* COM GPIO pin configuration */
    ...
    (void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, COM_CM33_RIF_RES_NUM_UART);
