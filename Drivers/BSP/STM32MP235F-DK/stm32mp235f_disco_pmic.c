/**
  ******************************************************************************
  * @file    stm32mp235f_disco_stpmic.c
...
/** @addtogroup STM32MP235F_DK_STPMU
  * @{
  */


/** @defgroup STM32MP235F_DK_STPMU_Private_Constants Private Constants
  * @{
  */
/* Driver for PMIC ---------------------------------------------------------------*/
...
/** @defgroup STM32MP235F_DK_STPMU_Private_Defines Private Defines
  * @{
 */
/* Private typedef -----------------------------------------------------------*/
...
/** @defgroup STM32MP235F_DK_STPMU_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32MP235F_DK_STPMU_Private_Functions Private Functionss
  * @{
  */
...
static int32_t STPMIC_Probe()
{
  ...
  if (!CompObj)
  {
    ...
    IOCtx.Init        = BSP_I2C7_Init;
    IOCtx.DeInit      = BSP_I2C7_DeInit;
    IOCtx.ReadReg     = BSP_I2C7_ReadReg;
    IOCtx.WriteReg    = BSP_I2C7_WriteReg;
...
uint32_t BSP_PMIC_DDR_Power_Off()
{
  ...
  /* disable vdd2_ddr */
  status = BSP_PMIC_REGU_Set_Off(VDD2_DDR);
  if (status != BSP_ERROR_NONE)
  {
    return status;
  }
  ...
  /* disable vdd1_ddr */
  return BSP_PMIC_REGU_Set_Off(VDD1_DDR);
}
