/**
  ******************************************************************************
  * @file    stm32mp235f_disco_bus.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32MP235XX-DK board
...
/** @defgroup STM32MP235F_DK_BUS BUS
  * @{
  */

/** @defgroup STM32MP235F_DK_BUS_Private_Constants BUS Private Constants
  * @{
  */
...
/** @defgroup STM32MP235F_DK_BUS_Private_Types BUS Private Types
  * @{
  */
typedef struct
{
...
/** @defgroup STM32MP235F_DK_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32MP235F_DK_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32MP235F_DK_BUS_Private_FunctionPrototypes BUS Private FunctionPrototypes
  * @{
  */
#if defined (CORE_CA35) || defined (CORE_CM33)
...
/** @defgroup STM32MP235F_DK_BUS_Exported_Functions BUS Exported Functions
  * @{
  */
#if defined (CORE_CA35) || defined (CORE_CM33)
...
/** @defgroup STM32MP235F_DK_BUS_Private_Functions BUS Private Functions
  * @{
  */
/**
...
static void I2C1_MspInit(I2C_HandleTypeDef *hI2c)
{
  ...
  if (RESMGR_STATUS_ACCESS_OK != ResMgr_Request(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_I2C1_ID))
  {
    Error_Handler();
  }
...
static void I2C1_MspDeInit(I2C_HandleTypeDef *hI2c)
{
  ...
  (void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_I2C1_ID);
}
...
static void I2C2_MspDeInit(I2C_HandleTypeDef *hI2c)
{
  ...
  (void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_I2C2_ID);
}
...
static void I2C7_MspInit(I2C_HandleTypeDef *hI2c)
{
  ...
  if (RESMGR_STATUS_ACCESS_OK != ResMgr_Request(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_I2C7_ID))
  {
    Error_Handler();
  }
...
static void I2C7_MspDeInit(I2C_HandleTypeDef *hI2c)
{
  ...
  (void)ResMgr_Release(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_I2C7_ID);
}
