/**
  ******************************************************************************
  * @file    stm32mp235f_disco.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage
  *          LEDs
  *          push-buttons
  *          COM ports
  *          available on STM32MP235F_DK board (MB1605) from STMicroelectronics.
  ******************************************************************************
  * @attention
  *
...
/**
  * @brief  This method returns the STM32MP235CXX EVAL BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
int32_t BSP_GetVersion(void)
{
  return (int32_t)STM32MP235F_DK_BSP_VERSION;
}
...
{
  return (uint8_t *)STM32MP235F_DK_BSP_BOARD_NAME;
}
...
{
  return (uint8_t *)STM32MP235F_DK_BSP_BOARD_ID;
}
...
/** @defgroup STM32MP235F_DK_LOW_LEVEL_Private_Functions Private Functions
  * @{
  */
...
static void USART_MspInit(UART_HandleTypeDef *huart)
{
  ...
  {
    /* USART2 clock config */
    (void)ResMgr_Request(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_USART2_ID);
  ...
  {
    /* LPUART clock config */
    (void)ResMgr_Request(RESMGR_RESOURCE_RIFSC, STM32MP23_RIFSC_LPUART1_ID);
